...
export const et: Translations = {
  ...
  editor: {
    ...
    sunChipModeHelp:
      "Mida päikesekiip näitab: otsest päikesekiirgust (vaikimisi), päikese asendit (asimuut ja kõrgus) või mõlemat. Asend ei vaja andurit, see tuleb kaardi enda päikesearvutustest.",
    sunChipModeIrradiance: "Kiirgustugevus",
    sunChipModePosition: "Päikese asend",
    sunChipModeBoth: "Mõlemad",
