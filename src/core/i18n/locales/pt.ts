...
export const pt: Translations = {
  ...
  editor: {
    ...
    sunChipModeHelp:
      "O que o chip do sol mostra: a irradiância solar ao vivo (predefinição), a posição do sol (azimute e elevação), ou ambas. A posição não precisa de sensor, vem dos próprios cálculos solares do cartão.",
