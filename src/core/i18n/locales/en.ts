...
export const en: Translations = {
    ...
    editor:
    {
        ...
        customEntityColorHelp:     'Colour of the custom entity chip, its leader line and its ring in the Clock view.',
        customEntityIntro: 'Custom entity: displayed only when BOTH sensors below are set. The power sensor feeds the live chip and the curve, the energy sensor feeds the energy views. Nothing is estimated.',
        customLegacyHint: 'Your previous custom entity was moved to its matching field below. Add the missing sensor to show the chip again.',
        customPowerEntity: 'Power sensor (live)',
        customPowerEntityHelp: 'A real power sensor (W/kW). Feeds the live chip, the scrub and the curve.',
        customEnergyEntity: 'Energy sensor (totals)',
        customEnergyEntityHelp: 'A cumulative energy meter (Wh/kWh). Feeds the energy views.',
