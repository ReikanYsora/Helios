...
export const sl: Translations = {
  ...
  editor: {
    ...
    sunChipModeHelp:
      "Kaj prikazuje čip sonca: živo sončno obsevanje (privzeto), položaj sonca (azimut in višino) ali oboje. Položaj ne potrebuje senzorja, izhaja iz lastnih sončnih izračunov kartice.",
