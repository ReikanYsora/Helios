...
export const fr: Translations = {
    cardName:        'Helios',
    cardDescription: '☀️ Une vue 2.5D temps réel de votre maison avec le soleil, la météo, la production solaire, la batterie et le réseau, plus les ombres projetées et une frise temporelle interactive',
    ...
    editor:
    {
        ...
        noUiDelayHint:                'Secondes d\'inactivité avant que la frise et les contrôles disparaissent en mode sans interface. 0 garde l\'interface masquée en permanence. Utilisé uniquement quand le mode sans interface est activé.',
        showTimeline:                 'Afficher la timeline',
        showTimelineHint:             'Affiche la frise temporelle et le sélecteur de période sous la scène. Désactivé, il ne reste que la scène.',
        showDetailPanel:              'Afficher les informations supplémentaires',
        showDetailPanelHint:          'Autorise le mini-panneau par chip (métriques agrégées) à s\'ouvrir en haut à droite au tap d\'un chip. Désactivé, il ne s\'affiche jamais.',
        showSunTimes:                 'Afficher les heures de lever / coucher du soleil',
        showSunTimesHint:             'Affiche les heures de lever et de coucher du soleil et leurs marqueurs aux pieds de l\'arc solaire.',
        lockRotation:                 'Verrouiller la rotation',
        lockRotationHint:             'Réglez l\'angle de vue directement dans l\'aperçu (glissez pour tourner et incliner la scène), puis activez le verrou pour le figer : le glisser-tourner et l\'auto-rotation au repos sont désactivés, l\'angle réglé est conservé.',
        ...
        chipsIntro:                   'Affichez ou masquez chaque entité, et choisissez son icône et sa couleur. La maison suit le chip sélectionné, ou votre couleur primaire par défaut.',
        ...
        solarIrradianceEntityHelp: 'Choisissez un capteur qui remonte l\'irradiance solaire globale en W/m² (typiquement une station météo Ecowitt / Davis / perso). Quand il est défini, son état actuel et son historique recorder remplacent Open-Meteo pour les valeurs live + passées partout où elles apparaissent (nombre sur la pastille soleil, axe Y du graphique PV, coloration de l\'arc solaire). Les heures de prévision continuent d\'utiliser Open-Meteo, un capteur ne peut pas avoir de valeurs dans le futur.',
        liveDataTitle: 'État de la configuration',
        liveDataIntro: 'Les chips live n\'affichent que des capteurs mesurés. Chaque famille a besoin du capteur de puissance optionnel de sa source du dashboard énergie - les courbes et totaux viennent toujours de vos compteurs.',
        liveSolarOk: 'Solaire : capteur de puissance live détecté.',
        liveSolarMissing: 'Solaire : pas de capteur de puissance live, le chip de production reste masqué. Ajoutez-le dans Paramètres > Tableaux de bord > Énergie > Panneaux solaires.',
        liveSolarAbsent: 'Solaire : pas configuré dans votre dashboard énergie. Ajoutez des panneaux solaires pour obtenir le chip de production.',
        liveGridOk: 'Réseau : capteur de puissance live détecté.',
        liveGridMissing: 'Réseau : pas de capteur de puissance live, les chips import/export restent masqués. Ajoutez-le dans Paramètres > Tableaux de bord > Énergie > Réseau.',
        liveGridMiswired: 'Réseau : le capteur live contredit vos compteurs (il semble ne mesurer qu\'un seul sens). Les chips restent masqués - configurez un capteur signé ou le mode Deux capteurs.',
        liveGridAbsent: 'Réseau : pas configuré dans votre dashboard énergie. Ajoutez le réseau pour obtenir les chips import et export.',
        liveBatteryOk: 'Batterie : les capteurs de puissance couvrent chaque batterie.',
        liveBatteryMissing: 'Batterie : puissance live manquante sur au moins une batterie, le chip de puissance reste masqué. Ajoutez le(s) capteur(s) dans Paramètres > Tableaux de bord > Énergie > Batterie.',
        liveBatteryAbsent: 'Batterie : pas configurée dans votre dashboard énergie. Ajoutez une batterie pour obtenir le chip charge et décharge.',
        ...
        groupsIntro:                   'Un groupe de suivi rassemble plusieurs appareils pour les suivre ensemble dans toutes les vues (chip scène, graphe). Pour chaque groupe, définissez son nom, sa couleur et son icône.',
        ...
        devicesEnergyNote:             'Voici les appareils individuels actuellement configurés dans votre tableau de bord Énergie Home Assistant. L\'œil affiche ou masque chacun partout, et la pastille l\'assigne à un groupe.',
        groupsSection:                 'Configuration des groupes de suivi',
        buildingClusterRadius: 'Rayon de regroupement maison',
        buildingClusterRadiusHelp: 'Rayon autour de la maison dans lequel les dépendances attenantes (vérandas, garages, abris) sont considérées comme faisant partie de la maison : elles sont rendues à la pleine opacité et couleur de la maison, et non en voisines estompées. À 0, seul le bâtiment principal est conservé.',
        ...
        resetOptionsWarning:   'Attention : ceci remet TOUTES les options de cette carte à leurs valeurs par défaut - visibilité, couleurs et icônes des chips, noms/couleurs/icônes des groupes, bâtiments, ombres, unités et tous les autres réglages. Vos données Home Assistant et votre tableau de bord Énergie ne sont pas touchés, mais votre personnalisation est effacée et irrécupérable.',
        resetOptionsDone:      'Options réinitialisées ✓',
        aboutSection:          'À propos',
        aboutVersionLabel:     'Version',
        aboutRepoCard:         'Helios',
        aboutCoffeeMessage:    'Je développe Helios seul, surtout la nuit, à traquer les petits détails jusqu\'à ce que le soleil et votre énergie prennent vie à l\'écran. S\'il a trouvé une place sur votre tableau de bord, ça me rend déjà heureux - une étoile sur GitHub encore plus, et un café garde tout ça en mouvement.',
