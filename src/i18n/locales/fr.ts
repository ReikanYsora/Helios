...
export const fr: Translations = {
    ...
    editor:
    {
        ...
        displayUpdateFrequencyHelp:   'Combien de fois par heure chaque graphique rafraîchit ses valeurs : 1 = un point par heure (courbe lissée, CPU minimal), 12 = un point toutes les 5 minutes (courbe précise, CPU maximal). Par défaut 4 = une valeur toutes les 15 minutes, un bon compromis entre précision visible et coût de rendu. Le plafond est à 12 / h car 5 minutes est la résolution la plus fine des statistiques Home Assistant. La courbe de prévision n\'est pas concernée : elle reste calée sur la cadence horaire native du modèle météo.',
