...
export const de: Translations = {
    ...
    editor:
    {
        ...
        homeConsumptionEntity:        'Überschreibung des Hausverbrauchs',
        homeConsumptionEntityHelp:    'Zeigt diesen Sensor auf der Hausverbrauchsanzeige statt des berechneten Werts an. Nur diese Anzeige ändert sich: Die animierten Flüsse und der Verlauf bleiben auf deiner Bilanz aus Solar, Netz und Batterie. Ein direkter Verbrauchssensor weicht meist um ein paar W ab (Messverluste, leicht unsynchrone Sensoren), eine Lücke, die in den Flüssen keinen sauberen Platz hat.',
        ...
        showAstro:                    'Astronomische Daten anzeigen',
        showAstroHint:                'Fügt die astronomischen Daten der Sonne (Höhe, Azimut, Sonnenaufgang, Sonnenhöchststand, Sonnenuntergang, Tageslänge) im Infofeld oben rechts unterhalb des Wetters hinzu.',
        outdoorTemperatureEntity:     'Außentemperatur',
        outdoorTemperatureEntityHelp: 'Zeigt diesen Sensor im Infofeld anstelle der Open-Meteo-Temperatur an. Wird in seiner eigenen Einheit gelesen.',
        windSpeedEntity:              'Windgeschwindigkeit',
        windSpeedEntityHelp:          'Zeigt diesen Sensor im Infofeld anstelle der Open-Meteo-Windgeschwindigkeit an. Wird in seiner eigenen Einheit gelesen.',
