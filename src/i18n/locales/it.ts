...
export const it: Translations = {
    ...
    editor:
    {
        ...
        homeConsumptionEntity:        'Sostituzione del consumo di casa',
        homeConsumptionEntityHelp:    'Mostra questo sensore sulla lettura del consumo di casa invece del valore calcolato. Cambia solo questa lettura: i flussi animati e lo storico restano sul tuo bilancio di solare, rete e batteria. Un sensore di consumo diretto di solito si discosta di qualche W (perdite di misura, sensori leggermente non sincronizzati), uno scarto che non ha un posto pulito nei flussi.',
        ...
        showAstro:                    'Mostra dati astronomici',
        showAstroHint:                'Aggiunge i dati astronomici del sole (altitudine, azimut, alba, mezzogiorno solare, tramonto, durata del giorno) al pannello informativo in alto a destra, sotto il meteo.',
        outdoorTemperatureEntity:     'Temperatura esterna',
        outdoorTemperatureEntityHelp: 'Mostra questo sensore sul pannello informativo invece della temperatura di Open-Meteo. Letto nella sua unità.',
        windSpeedEntity:              'Velocità del vento',
        windSpeedEntityHelp:          'Mostra questo sensore sul pannello informativo invece della velocità del vento di Open-Meteo. Letto nella sua unità.',
