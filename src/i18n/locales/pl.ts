...
export const pl: Translations = {
    ...
    editor:
    {
        ...
        noUiModeHint:                 'Wygasza timeline i elementy sterujące na karcie po kilku sekundach bezczynności. Dowolne dotknięcie lub ruch przywraca je z powrotem. Idealne do ekranu naściennego.',
        showAstro:                    'Pokaż dane astronomiczne',
        showAstroHint:                'Dodaje dane astronomiczne słońca (wysokość, azymut, wschód słońca, południe słoneczne, zachód słońca, długość dnia) do panelu informacyjnego w prawym górnym rogu, poniżej pogody.',
        outdoorTemperatureEntity:     'Temperatura zewnętrzna',
        outdoorTemperatureEntityHelp: 'Pokazuje ten czujnik na panelu informacyjnym zamiast temperatury Open-Meteo. Odczytywany we własnej jednostce.',
        windSpeedEntity:              'Prędkość wiatru',
        windSpeedEntityHelp:          'Pokazuje ten czujnik na panelu informacyjnym zamiast prędkości wiatru Open-Meteo. Odczytywany we własnej jednostce.',
