...
export const fi: Translations = {
    ...
    editor:
    {
        ...
        noUiModeHint:                 'Häivyttää timelinen ja kortin säätimet muutaman toimettoman sekunnin jälkeen. Mikä tahansa kosketus tai liike tuo ne takaisin. Loistava wall display -näyttöön.',
        showAstro:                    'Näytä tähtitieteelliset tiedot',
        showAstroHint:                'Lisää auringon tähtitieteelliset tiedot (korkeus, atsimuutti, auringonnousu, aurinkokeskipäivä, auringonlasku, päivän pituus) oikeaan yläkulmaan tietopaneeliin, sään alle.',
        outdoorTemperatureEntity:     'Ulkolämpötila',
        outdoorTemperatureEntityHelp: 'Näyttää tämän anturin tietopaneelissa Open-Meteon lämpötilan sijaan. Luetaan omassa yksikössään.',
        windSpeedEntity:              'Tuulen nopeus',
        windSpeedEntityHelp:          'Näyttää tämän anturin tietopaneelissa Open-Meteon tuulen nopeuden sijaan. Luetaan omassa yksikössään.',
