...
export const lv: Translations = {
    ...
    editor:
    {
        ...
        homeConsumptionEntity:        'Mājas patēriņa aizstāšana',
        homeConsumptionEntityHelp:    'Rāda šo sensoru mājas patēriņa rādījumā aprēķinātās vērtības vietā. Mainās tikai šis rādījums: animētās plūsmas un vēsture paliek saskaņā ar jūsu saules, tīkla un akumulatora bilanci. Tiešais patēriņa sensors parasti atšķiras par dažiem vatiem (mērījumu zudumi, sensori nedaudz nesinhronizēti) - šai atšķirībai plūsmās nav skaidras vietas.',
        ...
        showAstro:                    'Rādīt astronomiskos datus',
        showAstroHint:                'Pievieno saules astronomiskos datus (augstums, azimuts, saullēkts, saules pusdienlaiks, saulriets, dienas garums) augšējā labajā informācijas panelī, zem laikapstākļiem.',
        outdoorTemperatureEntity:     'Āra temperatūra',
        outdoorTemperatureEntityHelp: 'Rāda šo sensoru informācijas panelī Open-Meteo temperatūras vietā. Nolasa tā paša mērvienībā.',
        windSpeedEntity:              'Vēja ātrums',
        windSpeedEntityHelp:          'Rāda šo sensoru informācijas panelī Open-Meteo vēja ātruma vietā. Nolasa tā paša mērvienībā.',
        ...
        customEntity:              'Pielāgota entītija',
        customEntityHelp:          'Izvēlies jebkuru jaudas (W/kW) vai enerģijas (Wh/kWh) entītiju, ko parādīt kā papildu sarkanu mikroshēmu augšējā kreisajā stūrī.',
