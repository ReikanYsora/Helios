...
export const lt: Translations = {
    ...
    editor:
    {
        ...
        homeConsumptionEntity:        'Namų suvartojimo perrašymas',
        homeConsumptionEntityHelp:    'Rodo šį jutiklį namų suvartojimo rodmenyje vietoj apskaičiuotos reikšmės. Keičiasi tik šis rodmuo: animuoti srautai ir istorija lieka pagal jūsų saulės, tinklo ir baterijos balansą. Tiesioginis suvartojimo jutiklis paprastai skiriasi keliais vatais (matavimo nuostoliai, jutikliai šiek tiek nesinchronizuoti) - šiai spragai srautuose nėra tvarkingos vietos.',
        ...
        showAstro:                    'Rodyti astronominius duomenis',
        showAstroHint:                'Prideda saulės astronominius duomenis (aukštis, azimutas, saulėtekis, saulės vidurdienis, saulėlydis, dienos ilgumas) į viršutinį dešinį informacijos skydelį, po orais.',
        outdoorTemperatureEntity:     'Lauko temperatūra',
        outdoorTemperatureEntityHelp: 'Rodo šį jutiklį informacijos skydelyje vietoj Open-Meteo temperatūros. Nuskaitoma jo paties matavimo vienetais.',
        windSpeedEntity:              'Vėjo greitis',
        windSpeedEntityHelp:          'Rodo šį jutiklį informacijos skydelyje vietoj Open-Meteo vėjo greičio. Nuskaitoma jo paties matavimo vienetais.',
        installationSection: 'PV įrenginys',
        installationHint:   'Kiekvienas objektas, kurį Helios skaito (PV gamyba, importas / eksportas iš tinklo, akumuliatoriaus galia ir įkrovos lygis), gaunamas iš [Home Assistant energijos skydelio](/config/energy). Šis skyrius prideda tik įrenginio lygio detales, gerinančias prognozės tikslumą: pasirenkamas apšvitos jutiklis.',
        ...
        customEntity:              'Pasirinktinis objektas',
        customEntityHelp:          'Pasirink bet kurį galios (W/kW) ar energijos (Wh/kWh) objektą, kurį rodyti kaip papildomą raudoną lustą viršuje kairėje.',
        customEntityIcon:          'Pasirinktinio objekto piktograma',
        customEntityColor:         'Pasirinktinio objekto spalva',
        customEntityColorHelp:     'Pasirinktinio objekto lusto, jo jungties linijos ir jo laikrodžio žiedo spalva.',
