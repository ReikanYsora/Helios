...
export const nl: Translations = {
    ...
    editor:
    {
        ...
        batterySignHelp:              'Teken dat op de batterijchip wordt getoond. Standaard is min tijdens opladen en plus tijdens ontladen. Omgekeerd wisselt dit om. Verborgen toont de waarde zonder teken.',
        batterySignDefault:           'Standaard',
        batterySignInverted:          'Omgekeerd',
        batterySignHidden:            'Verborgen',
        homeConsumptionEntity:        'Huisverbruik overschrijven',
        homeConsumptionEntityHelp:    'Toont deze sensor op de weergave van het huisverbruik in plaats van de berekende waarde. Alleen deze weergave verandert: de geanimeerde stromen en de historie blijven gebaseerd op je balans van zon, net en batterij. Een directe verbruikssensor zit meestal een paar watt naast (meetverliezen, sensoren net niet synchroon), een verschil dat geen nette plek heeft in de stromen.',
        noUiMode:                     'Geen UI-modus',
        noUiModeHint:                 'Laat na een paar seconden inactiviteit de timeline en de bediening op de kaart vervagen. Elke tik of beweging haalt ze terug. Ideaal voor een wall display.',
        showAstro:                    'Astronomische gegevens tonen',
        showAstroHint:                'Voegt de astronomische gegevens van de zon (hoogte, azimut, zonsopkomst, zonhoogste stand, zonsondergang, daglengte) toe aan het infopaneel rechtsboven, onder het weer.',
        outdoorTemperatureEntity:     'Buitentemperatuur',
        outdoorTemperatureEntityHelp: 'Toont deze sensor op het infopaneel in plaats van de Open-Meteo-temperatuur. Wordt in de eigen eenheid gelezen.',
        windSpeedEntity:              'Windsnelheid',
        windSpeedEntityHelp:          'Toont deze sensor op het infopaneel in plaats van de Open-Meteo-windsnelheid. Wordt in de eigen eenheid gelezen.',
