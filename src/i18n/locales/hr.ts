...
export const hr: Translations = {
    ...
    editor:
    {
        ...
        homeConsumptionEntity:        'Zamjena potrošnje doma',
        homeConsumptionEntityHelp:    'Prikazuje ovaj senzor na očitanju potrošnje doma umjesto izračunate vrijednosti. Mijenja se samo ovo očitanje: animirani tokovi i povijest ostaju na tvojoj ravnoteži solara, mreže i baterije. Senzor izravne potrošnje obično odstupa za nekoliko W (gubici mjerenja, senzori malo neusklađeni), razmak koji nema čisto mjesto u tokovima.',
        ...
        showAstroHint:                'Dodaje astronomske podatke o suncu (visina, azimut, izlazak sunca, solarno podne, zalazak sunca, trajanje dana) u informacijsku ploču gore desno, ispod vremena.',
        outdoorTemperatureEntity:     'Vanjska temperatura',
        outdoorTemperatureEntityHelp: 'Prikazuje ovaj senzor na informacijskoj ploči umjesto Open-Meteo temperature. Očitava se u vlastitoj jedinici.',
        windSpeedEntity:              'Brzina vjetra',
        windSpeedEntityHelp:          'Prikazuje ovaj senzor na informacijskoj ploči umjesto Open-Meteo brzine vjetra. Očitava se u vlastitoj jedinici.',
        installationSection: 'PV instalacija',
        installationHint:   'Svaki entitet koji Helios čita (PV proizvodnja, uvoz / izvoz iz mreže, snaga baterije i stanje napunjenosti) povlači se iz [energetske nadzorne ploče Home Assistant](/config/energy). Ovaj odjeljak dodaje samo detalje instalacije koji poboljšavaju točnost prognoze: opcionalni senzor ozračenja.',
        ...
        customEntityColorHelp:     'Boja čipa prilagođenog entiteta, njegove vodeće crte i njegovog prstena na satu.',
