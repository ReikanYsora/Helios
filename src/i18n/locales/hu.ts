...
export const hu: Translations = {
    ...
    editor:
    {
        ...
        homeConsumptionEntity:        'Otthoni fogyasztás felülírása',
        homeConsumptionEntityHelp:    'Ezt az érzékelőt mutatja az otthoni fogyasztás kijelzésén a számított érték helyett. Csak ez a kijelzés változik: az animált áramlások és az előzmények a napelemes, hálózati és akkumulátoros egyensúlyodon maradnak. Egy közvetlen fogyasztásérzékelő általában néhány W-tal eltér (mérési veszteségek, kissé nem szinkronban lévő érzékelők), ez a rés az áramlásokban nem talál tiszta helyet.',
        ...
        customEntity:              'Egyéni entitás',
        customEntityHelp:          'Válassz bármilyen teljesítmény- (W/kW) vagy energiaentitást (Wh/kWh), hogy extra piros chipként jelenjen meg bal felül.',
