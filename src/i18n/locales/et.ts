...
export const et: Translations = {
    ...
    editor:
    {
        ...
        dataDisplaySection:           'Olemid ja andmete kuvamine',
        ...
        batterySignHelp:              'Aku kiibil kuvatav märk. Vaikimisi on laadimisel miinus ja tühjenemisel pluss. Ümberpööratud vahetab need. Peidetud kuvab väärtuse ilma märgita.',
        batterySignDefault:           'Vaikimisi',
        batterySignInverted:          'Ümberpööratud',
        batterySignHidden:            'Peidetud',
        homeConsumptionEntity:        'Kodu tarbimise alistamine',
        homeConsumptionEntityHelp:    'Kuvab kodu tarbimise näidul selle anduri arvutatud väärtuse asemel. Muutub ainult see näit: animeeritud vood ja ajalugu jäävad sinu päikese-, võrgu- ja akubilansi juurde. Otsene tarbimisandur eksib tavaliselt mõne W võrra (mõõtekaod, andurid kergelt sünkroonist väljas), lünk, millel pole voogudes selget kohta.',
        noUiMode:                     'Liideseta režiim',
        noUiModeHint:                 'Hajutab timeline\'i ja kaardi juhtnupud pärast mõnesekundilist tegevusetust. Iga puudutus või liigutus toob need tagasi. Suurepärane wall display jaoks.',
        showAstro:                    'Näita astronoomilisi andmeid',
        showAstroHint:                'Lisab päikese astronoomilised andmed (kõrgus, asimuut, päikesetõus, päikese keskpäev, päikeseloojang, päeva pikkus) üleval paremal asuvale infopaneelile, ilmateate alla.',
        outdoorTemperatureEntity:     'Välistemperatuur',
        outdoorTemperatureEntityHelp: 'Kuvab infopaneelil selle anduri Open-Meteo temperatuuri asemel. Loetakse selle enda ühikus.',
        windSpeedEntity:              'Tuule kiirus',
        windSpeedEntityHelp:          'Kuvab infopaneelil selle anduri Open-Meteo tuule kiiruse asemel. Loetakse selle enda ühikus.',
