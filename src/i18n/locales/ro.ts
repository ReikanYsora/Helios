...
export const ro: Translations = {
    ...
    editor:
    {
        ...
        showAstro:                    'Afiseaza datele astronomice',
        showAstroHint:                'Adauga datele astronomice ale soarelui (altitudine, azimut, rasarit, amiaza solara, apus, durata zilei) in panoul de informatii din dreapta sus, sub vreme.',
        outdoorTemperatureEntity:     'Temperatura exterioara',
        outdoorTemperatureEntityHelp: 'Afiseaza acest senzor in panoul de informatii in locul temperaturii Open-Meteo. Citit in propria unitate.',
        windSpeedEntity:              'Viteza vantului',
        windSpeedEntityHelp:          'Afiseaza acest senzor in panoul de informatii in locul vitezei vantului Open-Meteo. Citit in propria unitate.',
