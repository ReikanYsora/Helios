...
export const en: Translations = {
    ...
    editor:
    {
        ...
        lidarShadowQuality:    'LiDAR shadow quality',
        lidarShadowQualityHelp: 'Higher quality samples the LiDAR at a finer resolution for crisper shadows, but makes the card heavier. Lower it if the card feels heavier.',
        lidarQualityLow:       'Low',
        lidarQualityMedium:    'Medium',
        lidarQualityHigh:      'High',
        lidarSection:          'Local LiDAR',
        lidarHint:             'Point Helios at a self-hosted nDSM (normalised Digital Surface Model) GeoTIFF for true LiDAR shadows (buildings AND vegetation). The file must be reachable over HTTPS by your browser; the bounding box tells Helios which area it covers, in EPSG:4326 (plain latitude/longitude).',
        lidarEnabled:          'Use local LiDAR',
        lidarEnabledOn:        'On',
        lidarEnabledOff:       'Off',
        lidarUrl:              'nDSM GeoTIFF URL',
        lidarUrlHelp:          'Browser-reachable HTTPS URL of the nDSM GeoTIFF raster.',
        lidarMinLat:           'South latitude (min)',
        lidarMaxLat:           'North latitude (max)',
        lidarMinLon:           'West longitude (min)',
        lidarMaxLon:           'East longitude (max)',
        lidarBboxHelp:         'The raster\'s coverage in EPSG:4326. All four are required, and each max must be greater than its min, otherwise the local LiDAR is ignored.',
        resetSection:          'Reset',
