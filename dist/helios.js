    ...
    `}var chartIsDark=e=>!!e.hass?.themes?.darkMode;function pvValueAtTime(e,t,i){const r=(e._pvUnit||"").trim();if(!r)return{value:NaN,unit:"",isPredicted:!1};const s=r.toLowerCase(),n="wh"===s||"kwh"===s||"mwh"===s,l=n?"kwh"===s?"kW":"mwh"===s?"MW":"W":r,c=l.toLowerCase(),d="kw"===c?.001:"mw"===c?1e-6:1,u=getHomeCoords(e.config,e.hass);if(u&&getSunPosition(new Date(t),u.lat,u.lon).altitude<=0)return{value:0,unit:l,isPredicted:!1};const p=i??e._pvHistory,g=p&&p.times.length>=1?p.times[0].getTime():1/0,m=p&&p.times.length>=1?p.times[p.times.length-1].getTime():-1/0;if(p&&p.times.length>=2&&t>=g&&t<=m)if(n)for(let y=1;y<p.times.length;y++){const e=p.times[y].getTime();if(t>e)continue;const i=p.times[y-1].getTime();if(t<i)break;const r=(e-i)/36e5;if(r<=0||r>6)break;const s=p.values[y]-p.values[y-1];if(!isFinite(s)||s<0)break;return{value:Math.max(0,s/r),unit:l,isPredicted:!1}}else{const e=interpAt(p.times,p.values,t);if(isFinite(e))return{value:Math.max(0,e),unit:l,isPredicted:!1}}if(!i){const i=e._pvCalibStats;if(i&&i.times.length>=2&&t<=m)if(n)for(let e=1;e<i.times.length;e++){const r=i.times[e].getTime();if(t>r)continue;const s=i.times[e-1].getTime();if(t<s)break;const n=(r-s)/36e5;if(n<=0||n>6)break;const c=i.values[e]-i.values[e-1];if(!isFinite(c)||c<0)break;return{value:Math.max(0,c/n),unit:l,isPredicted:!1}}else{const e=interpAt(i.times,i.values,t);if(isFinite(e))return{value:Math.max(0,e),unit:l,isPredicted:!1}}}if(i)return{value:NaN,unit:l,isPredicted:!1};const f=e._unifiedStore;if(f){const e=valueAt(f.forecast,f,t);if(null!==e&&e>0)return{value:Math.max(0,e)*d,unit:l,isPredicted:!0}}return{value:NaN,unit:l,isPredicted:!1}}function renderTimelineHoverTooltip(e){const t=e._timeRange,i=e._chartSeries;if(!t)return G;const r=t.start.getTime(),s=t.end.getTime()-r;if(s<=0)return G;const n=e._chartHoverPct;if(null===n||n<0||n>100)return G;const l=n,c=r+l/100*s,d=i?interpAt(i.times,i.irradiance,c):NaN,u=i?interpAt(i.times,i.cloudLow,c):NaN,p=i?interpAt(i.times,i.cloudMid,c):NaN,g=i?interpAt(i.times,i.cloudHigh,c):NaN,m=e._customEntityHistory?interpAt(e._customEntityHistory.times,e._customEntityHistory.values,c):NaN,f=pvValueAtTime(e,c),y=e._chartTarget??"production",b=e._unifiedStore,_=b?valueAt(b.gridImport,b,c)??NaN:NaN,v=b?valueAt(b.gridExport,b,c)??NaN:NaN,w=b?valueAt(b.battery,b,c)??NaN:NaN,$=b?valueAt(b.production,b,c)??NaN:NaN,M=isFinite($)||isFinite(_)||isFinite(v)||isFinite(w),T=Math.max(0,(isFinite($)?$:0)+(isFinite(_)?_:0)-(isFinite(v)?v:0)-(isFinite(w)?w:0)),C=e._batterySocHistory?interpAt(e._batterySocHistory.times,e._batterySocHistory.values,c):NaN,F=valueDecimals(e.config),kw=t=>`${formatLocalisedNumber(e.hass,t/1e3,F)} kW`,H=e._pvHistoryPerEntity,E=H.size>1?Array.from(H.keys()):[],A=[];for(let U=0;U<E.length;U++){const t=E[U],i=H.get(t);if(!i)continue;const r=pvValueAtTime(e,c,i);if(!isFinite(r.value))continue;const s="W"===r.unit?0:F,n=`${formatLocalisedNumber(e.hass,r.value,s)} ${r.unit}`;A.push({id:t,label:solarSourceName(e,U),valueText:n,colorIdx:U})}const D=isFinite(f.value),R=clockTargetLabel(e,y),P=gridImportName(e),L=gridExportName(e),I=batteryChargeName(e),O=batteryDischargeName(e),z=e,W=ENERGY_COLOR_cloud(z),j=lerpHexToward(W,"#ffffff",.55),B=lerpHexToward(W,"#000000",.5),q=new Date(c),K=e.hass?.language||void 0,Y=s/864e5,X=Y<=2.05?{hour:"2-digit",minute:"2-digit"}:Y<=14.05?{weekday:"short",hour:"2-digit",minute:"2-digit"}:{weekday:"short",day:"numeric",month:"short"},Z=new Intl.DateTimeFormat(K,X).format(q),J=new Date(q);J.setHours(0,0,0,0);const Q=/* @__PURE__ */new Date;Q.setHours(0,0,0,0);const ee=J.getTime()===Q.getTime(),te=c>Date.now();let ie=function computeDailyKwhTotals(e){const t=/* @__PURE__ */new Map;if(!e._timeRange)return t;const{start:i,end:r}=e._timeRange,s=i.getTime(),n=r.getTime(),dayKey=e=>{const t=new Date(e);return t.setHours(0,0,0,0),t.getTime()},l=e._pvChangeSeries;if(l&&l.length>0){const e=new Date(s);for(e.setHours(0,0,0,0);e.getTime()<n;){const i=e.getTime(),r=new Date(e);r.setDate(r.getDate()+1);const s=sumChangeForDay(l,i,r.getTime());null!==s&&t.set(i,Math.max(0,s)),e.setTime(r.getTime())}}const c=e._unifiedStore;if(c){const e=Date.now(),i=c.stepMs/36e5;for(let r=0;r<c.bucketsTotal;r++){const l=c.storeStartMs+(r+.5)*c.stepMs;if(l<s||l>n)continue;if(l<e)continue;const d=c.forecast[r];if(null===d||!isFinite(d)||d<=0)continue;const u=dayKey(l);t.set(u,(t.get(u)??0)+d*i/1e3)}}return t}(e).get(J.getTime());ee&&!te&&"number"==typeof e._haSolarTodayKwh&&isFinite(e._haSolarTodayKwh)&&(ie=e._haSolarTodayKwh);const oe=te&&void 0!==ie&&isFinite(ie)&&ie>=.05,re=void 0!==ie&&isFinite(ie)&&ie>=.05?formatLocalisedNumber(e.hass,ie,F)+" kWh":"",ae=Date.now(),se=ae>=r&&ae<=r+s&&Math.abs(l-(ae-r)/s*100)<=1.2,ne=D&&"W"!==f.unit?F:0,le=(e.hass?.language||"").toLowerCase().startsWith("fr")?"Retour au live":"Back to live";return U`
        ...
        >
            <div class="tb-hover-tooltip">
                ...
                ${"production"===y?U`
                    ${oe&&re?U`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${ENERGY_COLOR_pv(z)}" icon="mdi:crystal-ball"></ha-icon>
                            <span class="tb-hover-tooltip-name">${R}</span>
                            <span class="tb-hover-tooltip-value">${re}</span>
                        </div>
                    `:G}
                    ${D?U`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${ENERGY_COLOR_pv(z)}" icon="mdi:solar-power"></ha-icon>
                            <span class="tb-hover-tooltip-name">${R}</span>
                            <span class="tb-hover-tooltip-value">${formatLocalisedNumber(e.hass,f.value,ne)} ${f.unit}</span>
                        </div>
                    `:G}
                    ${A.map(t=>U`
                ...
                ${"consumption"===y&&M?U`
                    <div class="tb-hover-tooltip-row">
                        <ha-icon class="tb-hover-tooltip-icon" style="color:${ENERGY_COLOR_consumption(z)}" icon="mdi:home-lightning-bolt"></ha-icon>
                        <span class="tb-hover-tooltip-name">${R}</span>
                ...
                ${"grid"===y?U`
                    ${isFinite(_)&&_>=1?U`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${ENERGY_COLOR_gridImport(z)}" icon="mdi:transmission-tower-export"></ha-icon>
                    ...
                    ${isFinite(v)&&v>=1?U`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${ENERGY_COLOR_gridExport(z)}" icon="mdi:transmission-tower-import"></ha-icon>
                ...
                ${"battery"===y?U`
                    ${isFinite(w)&&w>=1?U`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${ENERGY_COLOR_batteryIn(z)}" icon="mdi:battery-arrow-up"></ha-icon>
                    ...
                    ${isFinite(w)&&w<=-1?U`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${ENERGY_COLOR_batteryOut(z)}" icon="mdi:battery-arrow-down"></ha-icon>
                ...
                ${"battery-soc"===y&&isFinite(C)?U`
                    <div class="tb-hover-tooltip-row">
                        <ha-icon class="tb-hover-tooltip-icon" style="color:${ENERGY_COLOR_batteryOut(z)}" icon="mdi:battery"></ha-icon>
                        <span class="tb-hover-tooltip-name">${R}</span>
                ...
                ${"irradiance"===y&&isFinite(d)?U`
                    <div class="tb-hover-tooltip-row">
                        <ha-icon class="tb-hover-tooltip-icon" style="color:${ENERGY_COLOR_sun(z)}" icon="mdi:white-balance-sunny"></ha-icon>
                        <span class="tb-hover-tooltip-name">${R}</span>
                ...
                ${"custom"===y&&isFinite(m)?U`
                    <div class="tb-hover-tooltip-row">
                        <ha-icon class="tb-hover-tooltip-icon" style="color:${cssHex(z,"--red-color","#f44336")}" icon=${resolveCustomEntityIcon(e.hass,e.config)}></ha-icon>
                        <span class="tb-hover-tooltip-name">${R}</span>
                ...
                ${"cloud"===y?U`
                    ${isFinite(g)?U`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${B}" icon="mdi:format-vertical-align-top"></ha-icon>
                            <span class="tb-hover-tooltip-name">${R}</span>
                    ...
                    ${isFinite(p)?U`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${W}" icon="mdi:format-vertical-align-center"></ha-icon>
                            <span class="tb-hover-tooltip-name">${R}</span>
                ...
                <details class="advanced-section about-section" data-section="about" ?open=${"about"===this._openSection} @toggle=${this._onSectionToggleEvt}>
                    ...
                    <div class="about-row">
                        ...
                        <a class="about-row-link about-version-link"
                           href="https://github.com/ReikanYsora/Helios/releases/tag/v${"2026.7.1-a17"}"
