...
return new Date((l+c)/2)}var rt=null;function renderTimelineNightZones(e){const t=function computeNightIntervals(e){const t=e._timeRange;if(!t)return[];const i=getHomeCoords(e.config,e.hass);if(!i)return[];const r=t.start.getTime(),o=t.end.getTime(),n=o-r;if(n<=0)return[];const s=`${r}|${o}|${i.lat.toFixed(4)}|${i.lon.toFixed(4)}`;if(rt&&rt.key===s)return rt.out;const l=[],c=new Date(t.start);c.setHours(0,0,0,0),c.setDate(c.getDate()-1);const d=o+864e5;for(;c.getTime()<=d;){const e=c.getTime(),t=e+864e5,r=findSunCrossing(i.lat,i.lon,e,t,"rising"),o=findSunCrossing(i.lat,i.lon,e,t,"setting");r&&l.push({ms:r.getTime(),kind:"sunrise"}),o&&l.push({ms:o.getTime(),kind:"sunset"}),c.setDate(c.getDate()+1)}l.sort((e,t)=>e.ms-t.ms);const u=[];let p=null,g=!1;for(const f of l)"sunset"===f.kind?p=f.ms:(null!==p?(u.push({startMs:p,endMs:f.ms}),p=null):g||u.push({startMs:-1/0,endMs:f.ms}),g=!0);null!==p&&u.push({startMs:p,endMs:1/0});const m=[];for(const f of u){const e=Math.max(f.startMs,r),t=Math.min(f.endMs,o);t>e&&m.push({startPct:(e-r)/n*100,endPct:(t-r)/n*100})}return rt={key:s,out:m},m}(e);return 0===t.length?U``:U`
        ...
        >
            <div class="tb-hover-tooltip">
                <div class="tb-hover-tooltip-time">
                    ...
                    <span class="tb-hover-tooltip-time-label">${E}</span>
                    <span
    ...
    `}function interpAt(e,t,i){const r=Math.min(e.length,t.length);if(0===r)return NaN;if(i<=e[0].getTime())return isFinite(t[0])?t[0]:NaN;if(i>=e[r-1].getTime()){const e=t[r-1];return isFinite(e)?e:NaN}let o=0,n=r-1;for(;n-o>1;){const t=o+n>>1;e[t].getTime()<=i?o=t:n=t}const s=e[o].getTime(),l=e[n].getTime(),c=t[o],d=t[n];if(!isFinite(c)||!isFinite(d))return NaN;const u=l-s;return u<=0?d:c+(d-c)*(i-s)/u}function renderPvChart(e){const t=e,i=e._timeRange;e._pvHistory;const r=1e3,o=100;if(!i)return U`<svg class="hc-chart-svg" viewBox="0 0 ${r} ${o}" preserveAspectRatio="none"></svg>`;const n=i.start.getTime(),s=i.end.getTime()-n;if(s<=0)return U`<svg class="hc-chart-svg" viewBox="0 0 ${r} ${o}" preserveAspectRatio="none"></svg>`;const l=ENERGY_COLOR_pv(t),c=e.hass?.themes?.darkMode?lerpHexToward(l,"#ffffff",.55):lerpHexToward(l,"#000000",.35),d=i.end.getTime(),u=buildTimelineModel(i.start,i.end).dayBoundaries.map(e=>e*r),p=(e._pvUnit||"").toLowerCase(),g="wh"===p||"kwh"===p||"mwh"===p,m=e._unifiedStore,f=m?function sliceForRange(e,t,i){const r=Math.max(e.storeStartMs,t),o=Math.min(e.storeEndMs,i);if(o<=r)return{times:[],production:[],forecast:[],cloud:[],irradiance:[]};const n=e.stepMs,s=Math.floor((r-e.storeStartMs)/n),l=[],c=[],d=[],u=[],p=[];for(let g=e.storeStartMs+s*n+n/2;g<o;g+=n)g<r||(l.push(new Date(g)),c.push(valueAt(e.production,e,g)),d.push(valueAt(e.forecast,e,g)),u.push(valueAt(e.cloud,e,g)),p.push(valueAt(e.irradiance,e,g)));return{times:l,production:c,forecast:d,cloud:u,irradiance:p}}(m,n,d):null,xOf=e=>(e.getTime()-n)/s*r,y=(()=>{const e=g?"kwh"===p?"kw":"mwh"===p?"mw":"wh"===p?"w":"":p;return"kw"===e?.001:"mw"===e?1e-6:1})(),b=[];if(f)for(let P=0;P<f.times.length;P++){const e=f.production[P];null!==e&&isFinite(e)&&b.push({t:f.times[P],v:e*y})}const v=[];if(f)for(let P=0;P<f.times.length;P++){const e=f.forecast[P];null===e||!isFinite(e)||e<=0||v.push({t:f.times[P],v:e*y})}let _=1;for(const P of b)P.v>_&&(_=P.v);for(const P of v)P.v>_&&(_=P.v);const yOf=e=>o-90*Math.max(0,Math.min(1,e/_)),w=b.map(e=>`${xOf(e.t).toFixed(2)},${yOf(e.v).toFixed(2)}`);let $="",M="";if(w.length>=2){const e=xOf(b[0].t),t=xOf(b[b.length-1].t);$=`M ${e},100 L ${w.join(" L ")} L ${t},100 Z`,M=`M ${w.join(" L ")}`}const T=e._pvHistoryPerEntity.size>1?Array.from(e._pvHistoryPerEntity.keys()).sort():[],C=[];for(let P=0;P<T.length;P++){const t=T[P],i=e._pvHistoryPerEntity.get(t);if(!i)continue;let r=i.times,o=i.values;if(g&&r.length>=2){const e=.05,t=[],i=[];let n=0;for(let s=1;s<r.length;s++){const l=(r[s].getTime()-r[n].getTime())/36e5;if(l<=0)continue;if(l>6){n=s;continue}const c=o[s]-o[n];c<0?n=s:l<e||(t.push(r[s]),i.push(c/l),n=s)}r=t,o=i}const s=[],l=Math.max(1,Math.floor(r.length/750));for(let e=0;e<r.length;e+=l){const t=r[e],i=o[e],l=t.getTime();l<n||l>d||isFinite(i)&&s.push(`${xOf(t).toFixed(2)},${yOf(i).toFixed(2)}`)}s.length<2||C.push({id:t,line:`M ${s.join(" L ")}`,color:energySolarColor(e,chartIsDark(e),P)})}let F="";v.length>=2&&(F=`M ${v.map(e=>`${xOf(e.t).toFixed(2)},${yOf(e.v).toFixed(2)}`).join(" L ")}`);const A=e._chartHoverPct;let H=0,R=NaN,E=NaN,D=!1;if(null!==A&&A>=0&&A<=100){H=A/100*r;const e=n+A/100*s,t=b.length>0?b[b.length-1].t.getTime():-1/0;if(b.length>=1&&e<=t){const t=interpAt(b.map(e=>e.t),b.map(e=>e.v),e);isFinite(t)&&(R=yOf(Math.max(0,t)))}if(v.length>=1){const t=interpAt(v.map(e=>e.t),v.map(e=>e.v),e);isFinite(t)&&(E=yOf(Math.max(0,t)))}D=isFinite(R)||isFinite(E)}return U`
        ...
        ${D&&isFinite(R)?U`
            <div class="hc-hover-dot-html" style="left: ${(H/r*100).toFixed(2)}%; top: ${(R/o*100).toFixed(2)}%; background: ${l};"></div>
        `:K}
        ${D&&isFinite(E)?U`
            <div class="hc-hover-dot-html" style="left: ${(H/r*100).toFixed(2)}%; top: ${(E/o*100).toFixed(2)}%; background: ${c};"></div>
        `:K}
...
`;function __decorateMetadata(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)}function __decorate(e,t,i,r){var o,n=arguments.length,s=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,r);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(n<3?o(s):n>3?o(t,i,s):o(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s}var ct,ht,dt=(nt=class HeliosCardEditor extends se{constructor(...e){super(...e),this._cfg={},this._pickerReady=!1,this._openSection="location",this._sliderDebounce=/* @__PURE__ */new Map,this._solarRadiationEntityFilter=e=>{if(!e||!e.attributes)return!1;if("irradiance"===e.attributes.device_class)return!0;const t=String(e.attributes.unit_of_measurement??"").trim();return"W/m²"===t||"W/m2"===t},this._resetFeedback=null}disconnectedCallback(){super.disconnectedCallback();for(const e of this._sliderDebounce.values())window.clearTimeout(e);this._sliderDebounce.clear(),void 0!==this._resetFeedbackTimer&&(window.clearTimeout(this._resetFeedbackTimer),this._resetFeedbackTimer=void 0)}setConfig(e){const t=st._sanitiseConfig({...e}),i=!st._configEq(e,t);this._cfg=t,i&&this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t}}))}static _sanitiseConfig(e){const t={...e};for(const i of st._RETIRED_KEYS)i in t&&delete t[i];return t}static _configEq(e,t){const i=Object.keys(e).sort(),r=Object.keys(t).sort();if(i.length!==r.length)return!1;for(let o=0;o<i.length;o++)if(i[o]!==r[o])return!1;return!0}connectedCallback(){super.connectedCallback(),this._ensureEntityPicker()}async _ensureEntityPicker(){if(!this._pickerReady)if("undefined"!=typeof customElements&&customElements.get("ha-entity-picker"))this._pickerReady=!0;else try{const e=window;if("function"==typeof e.loadCardHelpers){const t=await e.loadCardHelpers();if(t?.createCardElement){const e=(await t.createCardElement({type:"entities",entities:[]}))?.constructor;"function"==typeof e?.getConfigElement&&await e.getConfigElement()}}"undefined"!=typeof customElements&&await Promise.race([customElements.whenDefined("ha-entity-picker"),new Promise(e=>setTimeout(e,8e3))])}catch(e){console.warn("[HELIOS] Failed to lazy-load ha-entity-picker:",e)}finally{this._pickerReady=!0}}_t(){return pickTranslations(this.hass?.language)}_update(e,t){const i={...this._cfg,[e]:t};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}})),this._cfg=i}_numField(e,t){const i=t.target.value.trim();if(""===i)return void this._update(e,void 0);const r=parseFloat(i);isFinite(r)&&this._update(e,r)}_numSlider(e,t){const i=parseFloat(t.target.value);if(!isFinite(i))return;this._cfg={...this._cfg,[e]:i};const r=String(e),o=this._sliderDebounce.get(r);void 0!==o&&window.clearTimeout(o);const n=window.setTimeout(()=>{this._sliderDebounce.delete(r),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._cfg}}))},st.SLIDER_COMMIT_DELAY_MS);this._sliderDebounce.set(r,n)}_onSectionToggle(e,t){const i=t.currentTarget;i.open?(this._openSection=e,requestAnimationFrame(()=>{i.scrollIntoView({behavior:"smooth",block:"start"})})):this._openSection===e&&(this._openSection=null)}_fmtNum(e,t){return t>=1?String(Math.round(e)):e.toFixed(2)}render(){const e=this._cfg,t=this._t(),i=this.hass?.config?.latitude,r=this.hass?.config?.longitude,o="number"==typeof i&&isFinite(i)?String(i):"52.379",n="number"==typeof r&&isFinite(r)?String(r):"4.900";return U`
                ...
                <div class="field field-block">
                    ...
                    ${this._pickerReady?U`
                        <ha-entity-picker
                            allow-custom-entity
                            .hass="${this.hass}"
                            .value="${String(e["solar-radiation-entity"]??"")}"
                            .includeDomains="${["sensor","input_number"]}"
                            .entityFilter="${this._solarRadiationEntityFilter}"
                            @value-changed="${e=>this._update("solar-radiation-entity",e.detail.value??"")}"
                        ></ha-entity-picker>
                    `:K}
                </div>
        ...
        `}_warnIfLegacyEntityKeys(e){if(this._legacyKeyWarningFired)return;if(!this.hass?.callService)return;const t=[];for(const r of ht._LEGACY_ENTITY_KEYS){const i=e[r];null!=i&&""!==i&&t.push(r)}if(0===t.length)return;this._legacyKeyWarningFired=!0;const i=`The Helios card no longer reads its PV, grid and battery entities from the card YAML. The following key${t.length>1?"s are":" is"} silently ignored: ${t.map(e=>"`"+e+"`").join(", ")}. Helios now resolves these directly from the official Home Assistant Energy dashboard (Settings → Dashboards → Energy → your sources). The PV forecast is also read from the Energy dashboard's configured solar forecast now, so the card no longer carries any PV install configuration. Only the entity slots and the forecast config were retired; the visual options still live in the card YAML.`;try{this.hass.callService("persistent_notification","create",{notification_id:"helios-legacy-entity-config",title:"Helios card: deprecated entity keys ignored",message:i})}catch(L){}}static getConfigElement(){return document.createElement("helios-card-editor")}static getStubConfig(e,t){if(e&&Array.isArray(t)&&t.length>0)for(const i of t){if("string"!=typeof i||!i.startsWith("zone."))continue;const t=e.states?.[i],r=t?.attributes?.latitude,o=t?.attributes?.longitude;if("number"==typeof r&&Number.isFinite(r)&&"number"==typeof o&&Number.isFinite(o))return{"home-latitude":r,"home-longitude":o}}return{}}getStatsSnapshot(){const e={};if(this.config)for(const[t,i]of Object.entries(this.config))"home-latitude"!==t&&"home-longitude"!==t&&(e[t]=i);return{config:e,engine:this._engine?this._engine.getStatsSnapshot():null,pv:{entityConfigured:""!==resolvePvLiveEntity(this._energyDefaults),unit:this._pvUnit||null,lastHistory:this._pvHistoryDiagnostics}}}invalidateLocation(){this._lastHomeKey="",this.requestUpdate()}resetDataCache(){this._pvHistory=null,this._pvCalibStats=null,this._pvChangeSeries=null,this._pvChangeSeriesFetchKey="",this._haSolarForecast=[],this._haSolarForecastLoaded=!1,this._haSolarForecastFetching=!1,this._haSolarForecastFetchedAt=0,this._pvCalibStatsFetchKey="",this._pvHistoryDiagnostics=null,this._gridImportChangeSeries=null,this._gridExportChangeSeries=null,this._gridImportChangeFetchKey="",this._gridExportChangeFetchKey="",this._batterySocHistory=null,this._batteryPowerHistory=null,this._batteryFetchKey="",this._batteryChargeChangeSeries=null,this._batteryDischargeChangeSeries=null,this._batteryChangeFetchKey="",this._solarRadiationHistory=null,this._solarRadiationFetchKey="",function clearPvModuleCaches(){Ke.clear()}(),function clearBatteryModuleCaches(){Ge.clear()}(),function clearRadiationModuleCaches(){Ye.clear()}(),function clearEnergyStatsCache(){qe.clear()}(),this._engine?.resetDataCache(),this.requestUpdate()}getCardSize(){return 15}getGridOptions(){return{rows:8,columns:12,min_rows:8,max_rows:24,min_columns:12,max_columns:12}}connectedCallback(){super.connectedCallback(),pt.add(this),this._connectedAt=performance.now(),this._dailyTotalsKicked=!1,tick(this),this._timer=window.setInterval(()=>{tick(this),refreshHaDailyTotals(this)},3e4),function initVisibilityObserver(e){if(e._visibilityObserver||"undefined"==typeof IntersectionObserver)return;let t=!0,i=!1;const applyState=()=>{const r="undefined"!=typeof document&&"hidden"===document.visibilityState,o=!t||r;if(function setAnimationsPaused(e,t){e.classList.toggle("helios-paused",t);const i=e.shadowRoot;if(!i)return;const r=i.querySelectorAll("svg");for(let o=0;o<r.length;o++){const e=r[o];try{t?e.pauseAnimations?.():e.unpauseAnimations?.()}catch(L){}}}(e,o),e._engine?.setPaused(o),i&&!r){const t=e;t._lastRefreshHassRef=void 0,t._lastRefreshConfigRef=void 0,t._lastRefreshTimeRangeRef=void 0,t._lastRefreshEnergyDefaultsRef=void 0,e.requestUpdate()}i=r};e._visibilityObserver=new IntersectionObserver(e=>{for(const i of e)t=i.isIntersecting;applyState()},{threshold:0}),e._visibilityObserver.observe(e),"undefined"!=typeof document&&(e._onVisibilityChange=applyState,document.addEventListener("visibilitychange",e._onVisibilityChange))}(this),"undefined"!=typeof document&&document.addEventListener("visibilitychange",this._onPageVisibilityForTheme),subscribeEnergyPrefs(this),refreshHaDailyTotals(this)}disconnectedCallback(){super.disconnectedCallback(),pt.delete(this),window.clearInterval(this._timer),this._visibilityObserver?.disconnect(),this._visibilityObserver=void 0,this._onVisibilityChange&&(document.removeEventListener("visibilitychange",this._onVisibilityChange),this._onVisibilityChange=void 0),"undefined"!=typeof document&&document.removeEventListener("visibilitychange",this._onPageVisibilityForTheme),function unsubscribeEnergyPrefs(e){if(e._energyPrefsUnsub){try{e._energyPrefsUnsub()}catch(L){}e._energyPrefsUnsub=void 0}}(this),function cancelPendingRespawn(e){const t=tt.get(e);void 0!==t&&(window.clearTimeout(t),tt.delete(e))}(this),void 0!==this._connectSettleTimer&&(window.clearTimeout(this._connectSettleTimer),this._connectSettleTimer=void 0),void 0!==this._engine&&(this._engine.cleanup(),this._engine=void 0),this._lastHomeKey="",this._initInflight=!1}updated(e){if(this._maybeRebuildUnifiedStore(),this._engine&&(e.has("_chartTarget")||e.has("_selectedTime")||e.has("hass")||e.has("_unifiedStore"))&&this._updateHomeAppearance(e.has("_chartTarget")),this.hass&&!this._energyPrefsUnsub&&subscribeEnergyPrefs(this),this._energyDefaultsLoaded&&!this._dailyTotalsKicked&&(this._dailyTotalsKicked=!0,refreshHaDailyTotals(this)),!this.hass?.config||!this.config)return;const t=getHomeCoords(this.config,this.hass);if(!t)return;const{lat:i,lon:r}=t,o=`${i.toFixed(5)},${r.toFixed(5)}`,n=o!==this._lastHomeKey;if(!this._engine||n){if(!this.isConnected)return;if(this._initInflight)return;const e=performance.now()-this._connectedAt,t=1e3;return e<t?(void 0!==this._connectSettleTimer&&window.clearTimeout(this._connectSettleTimer),void(this._connectSettleTimer=window.setTimeout(()=>{this._connectSettleTimer=void 0,this.isConnected&&this.requestUpdate()},t-e+16))):(this._lastHomeKey=o,this._lastConfigSig=computeConfigSig(this.config),void function initEngine(e){const t=performance.now(),i=e._lastEngineSpawnAt??0,r=t-i,o=t-it;if(r<600&&i>0||o<800){const t=tt.get(e);void 0!==t&&window.clearTimeout(t),e._initInflight=!0;const n=i>0?600-r:0,s=800-o,l=Math.max(n,s,0)+16,c=window.setTimeout(()=>{tt.delete(e),!1!==e.isConnected?initEngineNow(e):e._initInflight=!1},l);return void tt.set(e,c)}e._initInflight=!0,it=t,initEngineNow(e)}(this))}const s=computeConfigSig(this.config);s!==this._lastConfigSig&&(this._lastConfigSig=s,this._engine.updateConfig(this.config)),this.hass===this._lastRefreshHassRef&&this.config===this._lastRefreshConfigRef&&this._timeRange===this._lastRefreshTimeRangeRef&&this._energyDefaults===this._lastRefreshEnergyDefaultsRef||(this._lastRefreshHassRef=this.hass,this._lastRefreshConfigRef=this.config,this._lastRefreshTimeRangeRef=this._timeRange,this._lastRefreshEnergyDefaultsRef=this._energyDefaults,refreshPv(this),refreshBattery(this),refreshGrid(this),refreshSolarRadiation(this),fetchHaSolarForecast(this))}_resolveIsDark(e){let t;return e&&"boolean"==typeof e.darkMode?t=e.darkMode:this._cachedIsDarkThemesRef===e?t=this._cachedIsDark:(t=this._probeIsDarkFromCss(),this._cachedIsDarkThemesRef=e,this._cachedIsDark=t),this._engine?.setCardThemeIsDark(t),t}_probeIsDarkFromCss(){try{const e=getComputedStyle(this).getPropertyValue("--primary-background-color").trim();if(!e)return!1;const t=e.match(/^#([0-9a-f]{3}|[0-9a-f]{6})$/i);let i=0,r=0,o=0;if(t){const e=3===t[1].length?t[1].split("").map(e=>e+e).join(""):t[1];i=parseInt(e.slice(0,2),16),r=parseInt(e.slice(2,4),16),o=parseInt(e.slice(4,6),16)}else{const t=e.match(/(\d+)\s*,\s*(\d+)\s*,\s*(\d+)/);t&&(i=+t[1],r=+t[2],o=+t[3])}return(.299*i+.587*r+.114*o)/255<.5}catch(L){}return!1}_nudgeToHomePill(e,t,i,r){const o=ht.HOME_PILL_HALF_WIDTH_PX,n=ht.HOME_PILL_HALF_HEIGHT_PX,s=e-i,l=t-r,c=Math.max(0,o-n);if(Math.abs(s)<=c)return{x:e,y:r+(l>=0?1:-1)*n};const d=i+(s>=0?1:-1)*c,u=e-d,p=t-r,g=Math.sqrt(u*u+p*p)||1;return{x:d+n*u/g,y:r+n*p/g}}_renderSunCrossing(e,t,i,r){if(!e)return K;const o=e.x-t.x,n=e.y-t.y,s=Math.hypot(o,n)||1,l=e.x+o/s*22,c=e.y+n/s*22,d=e.time.toLocaleTimeString(this.hass?.locale?.language??void 0,{hour:"2-digit",minute:"2-digit"});return U`
            <div
...
<!--  Camera lock chip (top-left). Tapping flips the
                    ...
                    >
                        ${ke.map(e=>B`
                            <line
                                ...
                                x1="${e.x1}" y1="${e.y1}"
                                x2="${e.x2}" y2="${e.y2}"
                                stroke-width="${(ht.OUTLINE_FAR+(ht.OUTLINE_NEAR-ht.OUTLINE_FAR)*e.nearness)*ht.NIGHT_STROKE_FACTOR}"
                            ></line>
                        `)}
                        ${ke.map(e=>B`
                            <line
                                ...
                                x2="${e.x2}" y2="${e.y2}"
                                stroke="${e.color}"
                                stroke-width="${(ht.SEGMENT_FAR+(ht.SEGMENT_NEAR-ht.SEGMENT_FAR)*e.nearness)*ht.NIGHT_STROKE_FACTOR}"
                            ></line>
                        `)}
                    </svg>
                `:K}
                ...
                ${!e||null===t||null===F&&null===A||$?K:U`
                    ...
                    >
                        ...
                        <span>${formatGridValue(this.hass,ye?F??0:A??0,ye?H:R,p)}</span>
                    </div>
                `}
                    ...
                    >
                        ${Me.map(e=>B`
                            <line
                                ...
                                x1="${e.x1}" y1="${e.y1}"
                                x2="${e.x2}" y2="${e.y2}"
                                stroke-width="${ht.OUTLINE_FAR+(ht.OUTLINE_NEAR-ht.OUTLINE_FAR)*e.nearness}"
                            ></line>
                        `)}
                        ${Me.map(e=>B`
                            <line
                                ...
                                x2="${e.x2}" y2="${e.y2}"
                                stroke="${e.color}"
                                stroke-width="${ht.SEGMENT_FAR+(ht.SEGMENT_NEAR-ht.SEGMENT_FAR)*e.nearness}"
                            ></line>
                        `)}
                    </svg>
                `:K}
                    ...
                    <svg class="solar-svg solar-ray-svg"
                        ...
                        >
                            <animateMotion
                                dur="${Ee}s"
                                repeatCount="indefinite"
                                path="M ${_e.sun.x},${_e.sun.y} L ${De},${Pe}"
                            ></animateMotion>
                        </circle>
                    </svg>
                `:K}
                ...
                ${we?U`
                    <svg
                        ...
                        style="--solar-daylight:${_e.daylight}"
                    >
                        ${(()=>{const e=this._engine?.getSunArcScale()??1,t=Math.min((ht.SUN_R_FAR+(ht.SUN_R_NEAR-ht.SUN_R_FAR)*_e.sun.nearness)*e,22),i=t*He,r=3*t;return B`
                                <defs>
                                ...
                                <circle
                                    ...
                                    r="${t}"
                                    fill="${xe}"
                                    fill-opacity="${ht.SUN_FILL_OPACITY_BG}"
                                ></circle>
                                <circle
                ...
                ${Re&&this._cloudCover>=0?(()=>{const e=_e.sun.x,t=_e.sun.y-22,i=t-ht.CHIP_HALF_H_PX,r=this._engine?.getViewportWidth()??0,o=ht.CHIP_HALF_W_PX,n=o+16+76,s=r<=0||e+n<=r-8?1:e-n>=8?-1:e<r/2?1:-1,l=s>0?e+o+16:e-o-16,c=s>0?"translate(0, -100%)":"translate(-100%, -100%)";return U`
                        <div
