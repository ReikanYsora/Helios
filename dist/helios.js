...
return new Date((d+c)/2)}var kt=null;function renderTimelineNightZones(e){const t=function computeNightIntervals(e){const t=e._timeRange;if(!t)return[];const i=getHomeCoords(e.config,e.hass);if(!i)return[];const n=t.start.getTime(),r=t.end.getTime(),s=r-n;if(s<=0)return[];const l=`${n}|${r}|${i.lat.toFixed(4)}|${i.lon.toFixed(4)}`;if(kt&&kt.key===l)return kt.out;const d=[],c=new Date(t.start);c.setHours(0,0,0,0),c.setDate(c.getDate()-1);const u=r+864e5;for(;c.getTime()<=u;){const e=c.getTime(),t=e+864e5,n=findSunCrossing(i.lat,i.lon,e,t,"rising"),r=findSunCrossing(i.lat,i.lon,e,t,"setting");n&&d.push({ms:n.getTime(),kind:"sunrise"}),r&&d.push({ms:r.getTime(),kind:"sunset"}),c.setDate(c.getDate()+1)}d.sort((e,t)=>e.ms-t.ms);const p=[];let g=null,m=!1;for(const v of d)"sunset"===v.kind?g=v.ms:(null!==g?(p.push({startMs:g,endMs:v.ms}),g=null):m||p.push({startMs:-1/0,endMs:v.ms}),m=!0);null!==g&&p.push({startMs:g,endMs:1/0});const f=[];for(const v of p){const e=Math.max(v.startMs,n),t=Math.min(v.endMs,r);t>e&&f.push({startPct:(e-n)/s*100,endPct:(t-n)/s*100})}return kt={key:l,out:f},f}(e);return 0===t.length?K:B`
    ...
    `}(e):function renderTargetChart(e,t){const i=e,n=e._unifiedStore,r=e._timeRange,s=1e3,l=100;if(!n||!r)return B`<svg class="hc-chart-svg" viewBox="0 0 ${s} ${l}" preserveAspectRatio="none"></svg>`;const d=r.start.getTime(),c=r.end.getTime(),u=c-d;if(u<=0)return B`<svg class="hc-chart-svg" viewBox="0 0 ${s} ${l}" preserveAspectRatio="none"></svg>`;const xOf=e=>(e-d)/u*s,toPts=(e,t)=>{const i=[];for(let r=0;r<e.length;r++){const s=e[r];if(null===s||!isFinite(s))continue;const l=n.storeStartMs+(r+.5)*n.stepMs;l<d||l>c||i.push({t:l,v:t?t(s):s})}return i},sum=e=>e.reduce((e,t)=>e+t.v,0);let p,g=0,m=null;if("consumption"===t){const t=[];for(let e=0;e<n.production.length;e++){const i=n.production[e],r=n.gridImport[e],s=n.gridExport[e],l=n.battery[e];if(null===i&&null===r&&null===s&&null===l)continue;const u=n.storeStartMs+(e+.5)*n.stepMs;if(u<d||u>c)continue;const p=consumptionLoad(i??0,r??0,s??0,l??0);t.push({t:u,v:p})}p=[{pts:t,color:chipSlotColor(i,e.config,"home")}]}else if("grid"===t){const t=toPts(n.gridImport),r=toPts(n.gridExport);p=[{pts:t,color:chipSlotColor(i,e.config,"gridImport")},{pts:r,color:chipSlotColor(i,e.config,"gridExport")}]}else if("battery"===t){const t=toPts(n.battery,e=>Math.max(0,e)),r=toPts(n.battery,e=>Math.max(0,-e));p=[{pts:t,color:chipSlotColor(i,e.config,"batteryCharge")},{pts:r,color:chipSlotColor(i,e.config,"batteryDischarge")}];let s=0;for(const e of p)for(const t of e.pts)t.v>s&&(s=t.v);const l=e._batterySocPerBankHistory.length>0?e._batterySocPerBankHistory:e._batterySocHistory?[e._batterySocHistory]:[];if(l.length>0){const t=s>0?s/100:1,r=chipSlotColor(i,e.config,"batteryCharge"),u=chipSlotColor(i,e.config,"batteryDischarge"),f=cssHex(i,"--secondary-text-color","#9e9e9e"),flowColorAt=(e,t)=>{const i=Math.floor(((e+t)/2-n.storeStartMs)/n.stepMs),s=i>=0&&i<n.battery.length?n.battery[i]:null;return null===s||Math.abs(s)<5?f:s>0?r:u},v=[];for(const e of l){const i=[];for(let l=0;l<e.times.length;l++){const n=e.times[l].getTime();if(n<d||n>c)continue;const r=e.values[l];void 0!==r&&isFinite(r)&&i.push({t:n,v:Math.max(0,Math.min(100,r))*t})}if(i.length<2)continue;v.push(i);const n=i.length-1,r=[];for(let e=0;e<n;e++)r.push(flowColorAt(i[e].t,i[e+1].t));let s=0;for(let e=1;e<=n;e++)e!==n&&r[e]===r[s]||(p.push({pts:i.slice(s,e+1),color:r[s],lineOnly:!0,dashed:!0,noHoverDot:!0}),s=e)}v.length>0&&(m={banks:v,flowColorAt:flowColorAt}),g=s>0?s:100}}else if("battery-soc"===t){const t=e._batterySocHistory,n=[];if(t)for(let e=0;e<t.times.length;e++){const i=t.times[e].getTime();if(i<d||i>c)continue;const r=t.values[e];void 0!==r&&isFinite(r)&&n.push({t:i,v:r})}p=[{pts:n,color:chipSlotColor(i,e.config,"batteryDischarge")}],g=100}else isGroupTarget(t)?p=groupDevices(e.config,e._energyDefaults,groupOfTarget(t)).map(t=>({pts:toPts(changeSeriesToWatts(e._deviceChangeSeries.get(t.statConsumption)??null,n.storeStartMs,n.stepMs,n.bucketsTotal,Date.now()),e=>Math.abs(e)),color:deviceColorByIndex(i,t.index)})):(p=[{pts:toPts(n.irradiance),color:chipSlotColor(i,e.config,"irradiance")}],g=1e3);let f=g;if(f<=0){f=1;for(const e of p)for(const t of e.pts)t.v>f&&(f=t.v)}const v=10,yOf=e=>l-Math.max(0,Math.min(1,e/f))*(l-v),b=p.map(e=>{if(e.pts.length<2)return{area:"",line:"",color:e.color,dashed:!!e.dashed,total:sum(e.pts)};const t=e.pts.map(e=>`${xOf(e.t).toFixed(2)},${yOf(e.v).toFixed(2)}`),i=xOf(e.pts[0].t),n=xOf(e.pts[e.pts.length-1].t);return{area:e.lineOnly?"":`M ${i},${l} L ${t.join(" L ")} L ${n},${l} Z`,line:`M ${t.join(" L ")}`,color:e.color,dashed:!!e.dashed,total:sum(e.pts)}}),y=[];let w=null,_=null;if("irradiance"===t&&e._chartSeries){const t=e._chartSeries,n=[];for(let e=0;e<t.times.length;e++){const i=t.times[e].getTime();if(i<d||i>c)continue;const r=t.cloudLow[e],s=t.cloudMid[e],l=t.cloudHigh[e];(isFinite(r)||isFinite(s)||isFinite(l))&&n.push({t:i,lo:isFinite(r)?Math.max(0,r):0,mi:isFinite(s)?Math.max(0,s):0,hi:isFinite(l)?Math.max(0,l):0})}if(n.length>=2){const yOfPct=e=>l-Math.max(0,Math.min(1,e/100))*(l-v),e=[{pick:e=>e.lo,color:lerpHexToward(ENERGY_COLOR_cloud(i),"#ffffff",.55)},{pick:e=>e.mi,color:ENERGY_COLOR_cloud(i)},{pick:e=>e.hi,color:lerpHexToward(ENERGY_COLOR_cloud(i),"#000000",.5)}],t=new Array(n.length).fill(0);for(const i of e){const e=[],r=[];for(let s=0;s<n.length;s++){const l=t[s],d=l+i.pick(n[s]);t[s]=d,e.push(`${xOf(n[s].t).toFixed(2)},${yOfPct(d).toFixed(2)}`),r.push(`${xOf(n[s].t).toFixed(2)},${yOfPct(l).toFixed(2)}`)}y.push({area:`M ${e.join(" L ")} L ${r.reverse().join(" L ")} Z`,color:i.color})}w={bands:n,yOfPct:yOfPct,colors:e.map(e=>e.color)}}}let H="";if("irradiance"===t&&n){const e=sliceForRange(n,d,c),t=[];let i=0;for(let n=0;n<e.times.length;n++){const r=e.forecast[n];null===r||!isFinite(r)||r<=0||(t.push({t:e.times[n],v:r}),r>i&&(i=r))}if(t.length>=2&&i>0){const yOfF=e=>l-Math.max(0,Math.min(1,e/i))*(l-v);H=`M ${t.map(e=>`${xOf(e.t.getTime()).toFixed(2)},${yOfF(e.v).toFixed(2)}`).join(" L ")}`,_={pts:t.map(e=>({t:e.t.getTime(),v:e.v})),yOf:yOfF}}}const $=!!e.hass?.themes?.darkMode,j=chipSlotColor(i,e.config,"irradiance"),z=$?lerpHexToward(j,"#ffffff",.75):lerpHexToward(j,"#000000",.55),M=buildTimelineModel(r.start,r.end).dayBoundaries.map(e=>e*s),C=e._chartHoverPct;let D=0,A=!1;const R=[];if(null!==C&&C>=0&&C<=100){D=C/100*s;const e=d+C/100*u;for(const t of p){if(t.pts.length<1||t.noHoverDot)continue;const i=interpAt(t.pts.map(e=>new Date(e.t)),t.pts.map(e=>e.v),e);isFinite(i)&&(R.push({y:yOf(Math.max(0,i)),color:t.color}),A=!0)}if(m)for(const t of m.banks){if(t.length<1)continue;const i=interpAt(t.map(e=>new Date(e.t)),t.map(e=>e.v),e);isFinite(i)&&(R.push({y:yOf(Math.max(0,i)),color:m.flowColorAt(e,e)}),A=!0)}if(_&&_.pts.length>=1){const t=interpAt(_.pts.map(e=>new Date(e.t)),_.pts.map(e=>e.v),e);isFinite(t)&&t>0&&(R.push({y:_.yOf(t),color:z}),A=!0)}if(w&&w.bands.length>=1){const t=w.bands.map(e=>new Date(e.t)),i=interpAt(t,w.bands.map(e=>e.lo),e),n=interpAt(t,w.bands.map(e=>e.mi),e),r=interpAt(t,w.bands.map(e=>e.hi),e),s=[isFinite(i)?i:0,(isFinite(i)?i:0)+(isFinite(n)?n:0),(isFinite(i)?i:0)+(isFinite(n)?n:0)+(isFinite(r)?r:0)],l=[isFinite(i),isFinite(n),isFinite(r)];for(let e=0;e<3;e++)l[e]&&(R.push({y:w.yOfPct(s[e]),color:w.colors[e]}),A=!0)}}return B`
        <svg class="hc-chart-svg" viewBox="0 0 ${s} ${l}" preserveAspectRatio="none">
            ...
            <g class="hc-chart-grow">
                ...
                ${H?q`
                    <path class="hc-chart-line hc-chart-predicted" d="${H}" stroke="${z}" stroke-width="2" fill="none"></path>
                `:K}
            </g>
            ${A?q`
    ...
    `}function renderTimelineHoverTooltip(e){const t=e._timeRange,i=e._chartSeries;if(!t)return K;const n=t.start.getTime(),r=t.end.getTime()-n;if(r<=0)return K;const s=e._chartHoverPct;if(null===s||s<0||s>100)return K;const l=s,d=n+l/100*r,c=i?interpAt(i.times,i.irradiance,d):NaN,u=i?interpAt(i.times,i.cloudLow,d):NaN,p=i?interpAt(i.times,i.cloudMid,d):NaN,g=i?interpAt(i.times,i.cloudHigh,d):NaN,m=pvValueAtTime(e,d),f=e._chartTarget??"production",v=e._unifiedStore,b=v?valueAt(v.gridImport,v,d)??NaN:NaN,y=v?valueAt(v.gridExport,v,d)??NaN:NaN,w=v?valueAt(v.battery,v,d)??NaN:NaN,_=v?valueAt(v.production,v,d)??NaN:NaN,H=v?valueAt(v.forecast,v,d)??NaN:NaN,$=isFinite(_)||isFinite(b)||isFinite(y)||isFinite(w),j=consumptionLoad(isFinite(_)?_:0,isFinite(b)?b:0,isFinite(y)?y:0,isFinite(w)?w:0),z=e._batterySocHistory?interpAt(e._batterySocHistory.times,e._batterySocHistory.values,d):NaN,M=valueDecimals(e.config),C=powerUnit(e.config),D=irradianceUnit(e.config),kw=t=>formatPower(e.hass,t,M,C),A=e._pvChangeSeriesPerEntity,R=A.size>1?Array.from(A.keys()):[],E=[];for(let L=0;L<R.length;L++){const t=R[L],i=pvValueAtTime(e,d,t);if(!isFinite(i.value))continue;const n=formatPower(e.hass,pvNormalizeToWatts(i.value,i.unit),M,C);E.push({id:t,label:solarSourceName(e,L),valueText:n,colorIdx:L})}const T=isFinite(m.value),O=String(e.hass?.language??"").toLowerCase().startsWith("fr")?"Prévision":"Forecast",P=targetLabel(e,f),F=pickTranslations(e.hass?.language).cloudCover,I=function gridImportName(e){return e._energyDefaults.gridName||statFriendly(e,e._energyDefaults.gridStatEnergyFroms)}(e),U=function gridExportName(e){return e._energyDefaults.gridName||statFriendly(e,e._energyDefaults.gridStatEnergyTos)}(e),W=function batteryChargeName(e){return e._energyDefaults.batteryName||statFriendly(e,e._energyDefaults.batteryStatEnergyTos)}(e),q=function batteryDischargeName(e){return e._energyDefaults.batteryName||statFriendly(e,e._energyDefaults.batteryStatEnergyFroms)}(e),G=e,Y=isGroupTarget(f)?groupDevices(e.config,e._energyDefaults,groupOfTarget(f)).map(t=>{const i=wattsAtFromChangeSeries(e._deviceChangeSeries.get(t.statConsumption)??null,d);return{w:null===i?NaN:Math.abs(i),color:deviceColorByIndex(G,t.index),name:deviceName(e.hass,t),icon:deviceIcon(e.hass,t)}}):[],Z=ENERGY_COLOR_cloud(G),J=lerpHexToward(Z,"#ffffff",.55),X=lerpHexToward(Z,"#000000",.5),Q=chipSlotColor(G,e.config,"irradiance"),ee=chartIsDark(e)?lerpHexToward(Q,"#ffffff",.75):lerpHexToward(Q,"#000000",.55),te=(e._batterySocPerBankHistory.length>0?e._batterySocPerBankHistory:e._batterySocHistory?[e._batterySocHistory]:[]).map(e=>interpAt(e.times,e.values,d)),ie=targetLabel(e,"battery-soc"),ae=!isFinite(w)||Math.abs(w)<5?cssHex(G,"--secondary-text-color","#9e9e9e"):chipSlotColor(G,e.config,w>0?"batteryCharge":"batteryDischarge"),oe=new Date(d),ne=e.hass?.language||void 0,re=r/fe,se=re<=2.05?{hour:"2-digit",minute:"2-digit"}:re<=14.05?{weekday:"short",hour:"2-digit",minute:"2-digit"}:{weekday:"short",day:"numeric",month:"short"},le=new Intl.DateTimeFormat(ne,se).format(oe),de=new Date(oe);de.setHours(0,0,0,0);const ce=/* @__PURE__ */new Date;ce.setHours(0,0,0,0);const ue=de.getTime()===ce.getTime(),he=d>Date.now();let pe=function computeDailyKwhTotals(e){const t=/* @__PURE__ */new Map;if(!e._timeRange)return t;const{start:i,end:n}=e._timeRange,r=i.getTime(),s=n.getTime(),dayKey=e=>{const t=new Date(e);return t.setHours(0,0,0,0),t.getTime()},l=e._pvChangeSeries;if(l&&l.length>0){const e=new Date(r);for(e.setHours(0,0,0,0);e.getTime()<s;){const i=e.getTime(),n=new Date(e);n.setDate(n.getDate()+1);const r=sumChangeForDay(l,i,n.getTime());null!==r&&t.set(i,Math.max(0,r)),e.setTime(n.getTime())}}const d=e._unifiedStore;if(d){const e=Date.now(),i=d.stepMs/me;for(let n=0;n<d.bucketsTotal;n++){const l=d.storeStartMs+(n+.5)*d.stepMs;if(l<r||l>s)continue;if(l<e)continue;const c=d.forecast[n];if(null===c||!isFinite(c)||c<=0)continue;const u=dayKey(l);t.set(u,(t.get(u)??0)+c*i/1e3)}}return t}(e).get(de.getTime());ue&&!he&&"number"==typeof e._haSolarTodayKwh&&isFinite(e._haSolarTodayKwh)&&(pe=e._haSolarTodayKwh);const ge=he&&void 0!==pe&&isFinite(pe)&&pe>=.05,ve=void 0!==pe&&isFinite(pe)&&pe>=.05?formatEnergyKwh(e.hass,pe,M,C):"",be=Date.now(),ye=be>=n&&be<=n+r&&Math.abs(l-(be-n)/r*100)<=1.2,ke=(e.hass?.language||"").toLowerCase().startsWith("fr")?"Retour au live":"Back to live";return B`
        <div
            class="tb-hover-tooltip-tail ${ye?"is-magnet-snap":""}"
        ...
        >
            <div class="tb-hover-tooltip">
                <div class="tb-hover-tooltip-time">
                    ...
                    <span class="tb-hover-tooltip-time-label">${le}</span>
                    <span
                        class="tb-hover-tooltip-live-chip ${ye?"is-visible":""}"
                        aria-label=${ke}
                        aria-hidden=${ye?"false":"true"}
                    >
                    ...
                    <span class="tb-hover-tooltip-exact">${function formatHaDateTime(e,t){const i=e?.locale,n={day:"numeric",month:"short",hour:"numeric",minute:"2-digit",hour12:haUseAmPm(i)};try{return new Intl.DateTimeFormat(i?.language,n).format(t)}catch(L){return new Intl.DateTimeFormat(void 0,n).format(t)}}(e.hass,oe)}</span>
                </div>
                ${"production"===f?B`
                    ${ge&&ve?B`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${ee}" icon="mdi:crystal-ball"></ha-icon>
                            <span class="tb-hover-tooltip-name">${O}</span>
                            <span class="tb-hover-tooltip-value">${ve}</span>
                        </div>
                    `:K}
                    ${T?B`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${m.isPredicted?ee:chipSlotColor(G,e.config,"production")}" icon=${m.isPredicted?"mdi:crystal-ball":chipSlotIcon(e.config,"production","mdi:solar-power")}></ha-icon>
                            <span class="tb-hover-tooltip-name">${m.isPredicted?O:P}</span>
                            <span class="tb-hover-tooltip-value">${formatPower(e.hass,pvNormalizeToWatts(m.value,m.unit),M,C)}</span>
                        </div>
                    `:K}
                ...
                ${"battery"===f?B`
                    ...
                    ${isFinite(w)&&w<=-1?B`
                        <div class="tb-hover-tooltip-row">
                            ...
                            <span class="tb-hover-tooltip-name">${q}</span>
                            <span class="tb-hover-tooltip-value">${kw(-w)}</span>
                        </div>
                    `:K}
                    ${te.map((e,t)=>isFinite(e)?B`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${ae}" icon="mdi:battery"></ha-icon>
                            <span class="tb-hover-tooltip-name">${ie}${te.length>1?` ${t+1}`:""}</span>
                ...
                `:K}
                ${isGroupTarget(f)?Y.map(e=>isFinite(e.w)?B`
                    <div class="tb-hover-tooltip-row">
                ...
                ${"irradiance"===f&&isFinite(c)?B`
                    <div class="tb-hover-tooltip-row">
                        ...
                        <span class="tb-hover-tooltip-name">${P}</span>
                        <span class="tb-hover-tooltip-value">${formatIrradiance(e.hass,c,M,D)}</span>
                    </div>
                `:K}
                ...
                ${"irradiance"===f?B`
                    ${isFinite(g)?B`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${X}" icon="mdi:format-vertical-align-top"></ha-icon>
                            <span class="tb-hover-tooltip-name">${F.cloudHigh}</span>
                    ...
                    ${isFinite(p)?B`
                        <div class="tb-hover-tooltip-row">
                            ...
                            <span class="tb-hover-tooltip-name">${F.cloudMid}</span>
                    ...
                    ${isFinite(u)?B`
                        <div class="tb-hover-tooltip-row">
                            ...
                            <span class="tb-hover-tooltip-name">${F.cloudLow}</span>
...
`,jt={type:"helios-fingerprint-card",name:"Helios Energy Fingerprint",description:"A heatmap of your home's energy habits: intensity is consumption, colour is solar coverage.",preview:!0};window.customCards=window.customCards||[];var zt=window.customCards.findIndex(e=>"helios-fingerprint-card"===e.type);function __decorateMetadata(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)}function __decorate(e,t,i,n){var r,s=arguments.length,l=s<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(e,t,i,n);else for(var d=e.length-1;d>=0;d--)(r=e[d])&&(l=(s<3?r(l):s>3?r(t,i,l):r(t,i))||l);return s>3&&l&&Object.defineProperty(t,i,l),l}zt>=0?window.customCards[zt]=jt:window.customCards.push(jt);var Mt,Ct=[{name:"title",selector:{text:{}}}],Dt={title:"Title"},At=class HeliosFingerprintCardEditor extends le{constructor(...e){super(...e),this._config={type:""},this._computeLabel=e=>Dt[e.name]??e.name,this._valueChanged=e=>{e.stopPropagation(),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:{...this._config,...e.detail.value}},bubbles:!0,composed:!0}))}}setConfig(e){this._config={...e}}render(){return this.hass?B`
            <ha-form
                .hass=${this.hass}
                .data=${this._config}
                .schema=${Ct}
            ...
            </div>`}_renderDetail(){const e=this._t,t=this._model,i=this._detailRow;if(!t||null===i||i>=t.rows)return this._dayView=void 0,B`<div class="fp-detail is-empty"><span>${e.selectDay}</span></div>`;const n=t.cells[i],r=t.cols,s=r-1,l=t.hasBattery,d=this._hidden,c=!d.has("cons"),u=!d.has("imp"),p=!d.has("sol"),g=l&&!d.has("bat"),m=!d.has("loss"),f=this._disp?.cons??n.map(e=>e.consumption),v=this._disp?.imp??n.map(e=>e.gridImport),b=this._disp?.sol??n.map(e=>e.solar),y=this._disp?.bat??n.map(e=>e.batteryDischarge-e.batteryCharge);let w=1e-6,_=0;for(const P of n)if(P.hasData&&(w=Math.max(w,P.consumption,P.gridImport,P.solar),l)){const e=P.batteryDischarge-P.batteryCharge;w=Math.max(w,e),_=Math.min(_,e)}const H=w-_,yOf=e=>37-(e-_)/H*34;this._dayView={yMin:_,yMax:w,cons:f,imp:v,sol:b,bat:y,hasBattery:l,cols:r};const $=[0,1,2,3,4].map(e=>3+34*e/4),j=[.25,.5,.75].map(e=>e*r),coordsOf=e=>[...e.map((e,t)=>[t,yOf(e)]),[r,yOf(e[s])]],line=(e,t)=>q`<path class=${e} stroke-width=${2} vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" d=${t}></path>`,z=f.map((e,t)=>e+Math.max(0,-y[t])),M=[...b.map((e,t)=>[t,Math.min(yOf(e),yOf(z[t]))]),[r,Math.min(yOf(b[s]),yOf(z[s]))]],C=[[r,yOf(z[s])],...z.map((e,t)=>[s-t,yOf(z[s-t])])],D=`${getPath(M)} ${getPath(C).replace(/^M/,"L")} Z`,A=yOf(0),R=`${this._uid}-up`,E=`${this._uid}-down`,T=this.hass?.language||void 0,O=new Intl.DateTimeFormat(T,{weekday:"long",day:"numeric",month:"long"}).format(new Date(n[0].ms)),L=this._cursor,leg=(e,t,i)=>B`
            ...
            <div class="fp-detail">
                ...
                <div class="fp-chart" style="margin-left:${Et}px" @pointermove=${this._onChartMove} @pointerdown=${this._onChartMove} @pointerleave=${this._onChartLeave}>
                    ${q`
                        <svg class="fp-detail-svg" viewBox="0 0 ${r} ${Tt}" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                            ${g?q`<defs>
                                <clipPath id=${R}><rect x="0" y="0" width=${r} height=${A}></rect></clipPath>
                                <clipPath id=${E}><rect x="0" y=${A} width=${r} height=${Tt-A}></rect></clipPath>
                            </defs>`:K}
                            ${$.map(e=>q`<line class="fp-grid-line" x1="0" y1=${e} x2=${r} y2=${e} vector-effect="non-scaling-stroke"></line>`)}
                            ${j.map(e=>q`<line class="fp-grid-line" x1=${e} y1=${3} x2=${e} y2=${37} vector-effect="non-scaling-stroke"></line>`)}
                    ...
                    ${$.map((e,t)=>B`<span class="fp-yval" style="top:${(e/Tt*100).toFixed(2)}%">${this._fmtKwh(_+(1-t/4)*H)}${0===t?" kWh":""}</span>`)}
                    ${L?B`
            ...
            </ha-card>`}},Mt.styles=$t,Mt);__decorate([n$1({attribute:!1}),__decorateMetadata("design:type",Object)],Ot.prototype,"hass",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Ot.prototype,"_config",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Ot.prototype,"_energyDefaults",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Ot.prototype,"_energyDefaultsLoaded",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Ot.prototype,"_model",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Ot.prototype,"_weekOffset",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Ot.prototype,"_hover",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Ot.prototype,"_detailRow",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Ot.prototype,"_cursor",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Ot.prototype,"_hidden",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Ot.prototype,"_navLoading",void 0),__decorate([e$2(".fp-svg"),__decorateMetadata("design:type","undefined"==typeof SVGSVGElement?Object:SVGSVGElement)],Ot.prototype,"_svg",void 0),__decorate([e$2(".fp-chart"),__decorateMetadata("design:type","undefined"==typeof HTMLElement?Object:HTMLElement)],Ot.prototype,"_chart",void 0),Ot=__decorate([t$2("helios-fingerprint-card")],Ot);var Lt,Pt,Ft=i$6`
    .editor
    {
        padding: 16px;
        display: flex;
...
`,It=(Lt=class HeliosCardEditor extends le{constructor(...e){super(...e),this._cfg={},this._pickerReady=!1,this._openSection=null,this._sliderDebounce=/* @__PURE__ */new Map,this._energyDefaults=Xe,this._energyDefaultsLoaded=!1,this._gridGuard={status:"unknown",cleanEvals:0,fetchKey:"",fetching:!1,entityKey:""},this._onSectionToggleEvt=e=>{const t=e.currentTarget.dataset.section;t&&this._onSectionToggle(t,e)},this._onNumFieldChange=e=>{const t=e.currentTarget.dataset.key;t&&this._numField(t,e)},this._onNumSliderInput=e=>{const t=e.currentTarget.dataset.key;t&&this._numSlider(t,e)},this._onEntityValueChanged=e=>{const t=e.currentTarget.dataset.key;if(!t)return;const i=e.detail.value,n=null==i||""===i?void 0:i;(this._cfg[t]??void 0)!==(n??void 0)&&this._update(t,n)},this._onBoolToggleClick=e=>{const t=e.currentTarget,i=t.dataset.key;i&&this._update(i,"true"===t.dataset.value)},this._onDeviceToggleClick=e=>{const t=e.currentTarget.dataset.stat;if(!t)return;const i=this._cfg["hidden-devices"],n=Array.isArray(i)?i.filter(e=>"string"==typeof e):[],r=n.includes(t)?n.filter(e=>e!==t):[...n,t];this._update("hidden-devices",r.length?r:void 0)},this._onDeviceGroupClick=e=>{const t=e.currentTarget.dataset.stat;if(!t)return;const i=monitoringGroups(this._cfg),n=(i.get(t)??0)+1,r=n>4?0:n,s={};for(const[l,d]of i)l!==t&&(s[l]=d);r>=1&&(s[t]=r),this._update("monitoring-groups",Object.keys(s).length?s:void 0)},this._solarIrradianceEntityFilter=e=>{if(!e||!e.attributes)return!1;if("irradiance"===e.attributes.device_class)return!0;const t=String(e.attributes.unit_of_measurement??"").trim();return"W/m²"===t||"W/m2"===t},this._onGroupNameChanged=e=>{const t=e.currentTarget;t.dataset.group&&this._updateGroupMap("monitoring-group-names",t.dataset.group,t.value.trim())},this._onGroupColorChanged=e=>{e.stopPropagation();const t=e.currentTarget.dataset.group;t&&this._updateGroupMap("monitoring-group-colors",t,"string"==typeof e.detail.value?e.detail.value:"")},this._onGroupIconChanged=e=>{e.stopPropagation();const t=e.currentTarget.dataset.group;t&&this._updateGroupMap("monitoring-group-icons",t,"string"==typeof e.detail.value?e.detail.value:"")},this._onGroupVisibleClick=e=>{const t=e.currentTarget,i=t.dataset.group;if(!i)return;const n=this._cfg["monitoring-group-hidden"],r=n&&"object"==typeof n&&!Array.isArray(n)?{...n}:{};"true"===t.dataset.value?delete r[i]:r[i]=!0,this._update("monitoring-group-hidden",Object.keys(r).length?r:void 0)},this._resetFeedback=null,this._optionsResetArmed=!1,this._optionsResetFeedback=null}disconnectedCallback(){super.disconnectedCallback(),unsubscribeEnergyPrefs(this);for(const e of this._sliderDebounce.values())window.clearTimeout(e);this._sliderDebounce.clear();for(const e of[this._resetFeedbackTimer,this._optionsResetConfirmTimer,this._optionsResetFeedbackTimer])void 0!==e&&window.clearTimeout(e);this._resetFeedbackTimer=void 0,this._optionsResetConfirmTimer=void 0,this._optionsResetFeedbackTimer=void 0}setConfig(e){if(this._cfg={...e},Pt.LEGACY_KEYS.some(e=>e in this._cfg)&&setTimeout(()=>{if(!this.isConnected)return;const e={...this._cfg};let t=!1;for(const i of Pt.LEGACY_KEYS)i in e&&(delete e[i],t=!0);t&&(this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e}})),this._cfg=e)},0),!this._cfg["cache-id"]){const e=`c${Date.now().toString(36)}${Math.floor(1e9*Math.random()).toString(36)}`;setTimeout(()=>{this.isConnected&&(this._cfg["cache-id"]||this._update("cache-id",e))},0)}}connectedCallback(){super.connectedCallback(),this._ensureEntityPicker(),subscribeEnergyPrefs(this)}async _ensureEntityPicker(){if(!this._pickerReady)if("undefined"!=typeof customElements&&customElements.get("ha-entity-picker"))this._pickerReady=!0;else try{const e=window;if("function"==typeof e.loadCardHelpers){const t=await e.loadCardHelpers();if(t?.createCardElement){const e=(await t.createCardElement({type:"entities",entities:[]}))?.constructor;"function"==typeof e?.getConfigElement&&await e.getConfigElement()}}"undefined"!=typeof customElements&&await Promise.race([customElements.whenDefined("ha-entity-picker"),new Promise(e=>{setTimeout(e,Pt.PICKER_LOAD_TIMEOUT_MS)})])}catch(e){}finally{this._pickerReady=!0}}_t(){return pickTranslations(this.hass?.language)}updated(){this.hass&&refreshGridGuard(this),this._pruneStaleDeviceIds()}_pruneStaleDeviceIds(){if(!this._energyDefaultsLoaded)return;const e=this._energyDefaults.devices;if(0===e.length)return;const t=new Set(e.map(e=>e.statConsumption)),i=["hidden-devices"],n={...this._cfg};let r=!1;for(const l of i){const e=this._cfg[l];if(!Array.isArray(e))continue;const i=e.filter(e=>"string"==typeof e&&t.has(e));i.length!==e.length&&(r=!0,i.length?n[l]=i:delete n[l])}const s=this._cfg["monitoring-groups"];if(s&&"object"==typeof s&&!Array.isArray(s)){const e={};let i=!1;for(const[n,r]of Object.entries(s))t.has(n)&&"number"==typeof r?e[n]=r:i=!0;i&&(r=!0,Object.keys(e).length?n["monitoring-groups"]=e:delete n["monitoring-groups"])}r&&(this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n}})),this._cfg=n)}_liveStatusLine(e,t,i){return B`
        ...
        `}_renderChipsSection(e){return B`
        ...
        `}_renderChipBox(e,t,i){const n=this._cfg,r=chipVisible(this._cfg,t),s=this._t();return B`
                <div class="group-block">
                    ...
                    ${this._pickerReady?i.map(e=>{const t=wt[e];return B`
        ...
        `}render(){const e=null!==getHomeCoords(this.host.config,this.host.hass),t=!1!==this.host._interactive,i=this.host._labelLayout,n=this.host.config,r=chipVisible(n,"chip-irradiance-visible"),s=chipVisible(n,"chip-production-visible"),l=chipVisible(n,"chip-grid-visible"),d=chipVisible(n,"chip-battery-visible"),c=chipSlotColor(this.host,n,"irradiance"),u=!chipVisible(n,"chip-home-visible"),p=resolvePvLiveEntity(this.host._energyDefaults),g=chipSlotColor(this.host,n,"production"),m=!this.host._isLiveMode&&null!==this.host._selectedTime,f=m&&this.host._selectedTime.getTime()>Date.now()+6e4,v=""!==p&&null!==i?m?function pvRateAtTime(e,t){const i=wattsAtFromChangeSeries(e._pvChangeSeries,t.getTime());return null===i?null:{value:Math.max(0,i),unit:"W"}}(this.host,this.host._selectedTime):null!==this.host._pvCurrent?function currentPvRate(e){const t=e._energyDefaults.solarStatRates;if(0===t.length)return null;const{watts:i,any:n}=sumLiveWatts(e.hass,t);return n?{value:Math.max(0,i),unit:"W"}:null}(this.host):null:null;let b=null;if(f&&""!==p&&null!==i&&this.host._unifiedStore){const e=valueAt(this.host._unifiedStore.forecast,this.host._unifiedStore,this.host._selectedTime.getTime());null!==e&&e>0&&(b={value:e,unit:"W"})}const y=f&&null!==b,w=y?b:v,_=e&&s&&null!==i&&""!==p&&null!==w&&(!f||y)&&(!m||w.value>0),H=valueDecimals(this.host.config),$=powerUnit(this.host.config),j=irradianceUnit(this.host.config),z=_?(y?"~ ":"")+formatPvValue(this.host.hass,w.value,w.unit,H,$):"",M=null!==v?pvNormalizeToWatts(v.value,v.unit):0,C=flowDuration(M,5e3,.5),D=!(M>0),A=resolveBatteryEntities(this.host._energyDefaults),R=null!==A.socEntity,E=null!==A.powerEntity,T=!this.host._isLiveMode&&null!==this.host._selectedTime,O=T&&this.host._selectedTime.getTime()>Date.now()+6e4,L=T&&!O?this.host._selectedTime.getTime():null,P=null!==L?wattsAtFromChangeSeries(this.host._gridImportChangeSeries,L):this.host._gridImportValue,F=null!==L?wattsAtFromChangeSeries(this.host._gridExportChangeSeries,L):this.host._gridExportValue,I=null===P?null:Math.max(0,P),U=null===F?null:Math.max(0,F),W=null!==L?"W":this.host._gridImportUnit,G=null!==L?"W":this.host._gridExportUnit,Y=T?function batterySampleAtTime(e,t){if(!e||0===e.times.length)return null;const i=t.getTime(),n=e.times[0].getTime(),r=e.times[e.times.length-1].getTime();if(i<n||i>r+6e4)return null;let s=e.times.length-1;for(let l=0;l<e.times.length;l++)if(e.times[l].getTime()>i){s=l-1;break}return s<0&&(s=0),e.values[s]}(this.host._batterySocHistory,this.host._selectedTime):this.host._batterySoc;let Z;if(T){const e=this.host._selectedTime.getTime(),t=wattsAtFromChangeSeries(this.host._batteryChargeChangeSeries,e),i=wattsAtFromChangeSeries(this.host._batteryDischargeChangeSeries,e);Z=null===t&&null===i?null:Math.max(0,t??0)-Math.max(0,i??0)}else Z=this.host._batteryPower;const J=T?"W":this.host._batteryPowerUnit,X=e&&null!==i&&!O&&R&&null!==Y,Q=e&&null!==i&&!O&&E&&null!==Z,ee=(X||Q)&&d,te=X?`${Math.round(Y)} %`:"",ie=Q?function formatBatteryPower(e,t,i,n,r="kW",s="default"){const l=pvNormalizeToWatts(t,i);return"hidden"===s?formatPowerKw(e,Math.abs(l),n,!1,r):formatPowerKw(e,"inverted"===s?-l:l,n,!0,r)}(this.host.hass,-Z,J,H,$,function batterySign(e){const t=e?.["battery-sign"];return"inverted"===t||"hidden"===t?t:"default"}(this.host.config)):"",ae=f||null===w?null:pvNormalizeToWatts(w.value,w.unit),oe=null!==I||null!==U?(I??0)-(U??0):null,ne=Q?Z:null,re=this.host._energyDefaults,se=T||(0===re.solarStatEnergyFroms.length||null!==ae)&&(0===re.gridStatEnergyFroms.length&&0===re.gridStatEnergyTos.length||null!==oe)&&(0===re.batteryStatEnergyFroms.length&&0===re.batteryStatEnergyTos.length||null!==ne)?null===ae&&null===oe&&null===ne?null:Math.max(0,(ae??0)+(oe??0)-(ne??0)):null,le=e&&null!==i&&!O&&null!==se,de=le?formatGridValue(this.host.hass,se,"W",H,$):"",ce=Q&&Z>0,ue=Q&&Z<0,he=chipSlotColor(this.host,n,"batteryCharge"),pe=chipSlotColor(this.host,n,"batteryDischarge"),ge=ce?he:pe;this._batteryLeaderColor=ge;const me=Q?Math.abs(pvNormalizeToWatts(Z,J)):0,fe=Q&&me<5,ve=flowDuration(me,5e3),be=i?.batteryLabel.x??0,ye=i?.batteryLabel.y??0,ke=chipSlotIcon(n,ce?"batteryCharge":"batteryDischarge",function batteryLevelIcon(e,t){if(null===e||!isFinite(e))return"mdi:battery";const i=Math.max(0,Math.min(100,10*Math.round(e/10)));return t?i>=100?"mdi:battery-charging-100":i<=0?"mdi:battery-charging-outline":`mdi:battery-charging-${i}`:i>=100?"mdi:battery":i<=0?"mdi:battery-outline":`mdi:battery-${i}`}(X?Y:null,ce)),we=Q?ie:te,_e=ye-4.2,Se=!!(i&&ce&&_)?ye+4.2:ye,xe=i&&ee&&ue?this._buildLPathToHome(i,be,Se,22):"",He=i&&ee&&!ue?this._buildLPathToHome(i,be,Se,22):"",$e=i&&ce&&_?this._buildLPath(i.pvLabel.x+14,i.pvLabel.y+11,be-30,_e,!0):"",je=this._buildLPathToHome(i,i?.gridLabel.x??0,i?.gridLabel.y??0,22),ze=[.32,.44,.6799999999999999,.56],Me=i?.gridLabel.x??0,Ce=i?.batteryLabel.x??0,De=i?.home.x??0,Ae=i?.groupLabels[0]?.y??0,Re=i?.groupLabels[1]?.y??0,Ee=this.host._isLiveMode||null===this.host._selectedTime?null:this.host._selectedTime.getTime(),Te=i?function activeGroups(e,t){const i=[];for(let n=1;n<=4;n++)groupDevices(e,t,n).length>0&&i.push(n);return i}(this.host.config,this.host._energyDefaults).filter(e=>groupChipVisible(n,e)):[],Oe=Te.length,Le=i?Te.map((e,t)=>{let n,r,s=!1;if(1===Oe)n={x:De,y:Re},r=this._buildVerticalLeadFromHome(i,De,n.y);else if(4===Oe){const e=t<2;n={x:e?Me:Ce,y:t%2==0?Ae:Re};const s=e?n.x+48:n.x-48,l=i.home.x+96*(ze[t]-.5),d=i.home.y+14;r=this._buildLPath(l,d,s,n.y,!0)}else t<2?(n={x:0===t?Me:Ce,y:Ae},r=this._buildLPathToHome(i,n.x,n.y,22),s=!0):(n={x:De,y:Re},r=this._buildVerticalLeadFromHome(i,De,n.y));const l=null!==Ee?function groupPowerWAt(e,t,i){let n=0,r=!1;for(const s of groupDevices(e.config,e._energyDefaults,t)){const t=wattsAtFromChangeSeries(e._deviceChangeSeries.get(s.statConsumption)??null,i);null!==t&&(n+=t,r=!0)}return r?n:null}(this.host,e,Ee):function groupLivePowerW(e,t){const i=groupDevices(e.config,e._energyDefaults,t).map(e=>e.statRate).filter(e=>""!==e);if(0===i.length)return null;const{watts:n,any:r}=sumLiveWatts(e.hass,i);return r?n:null}(this.host,e),d=monitoringGroupColor(this.host.config,e),c=monitoringGroupIcon(this.host.config,e),u=null===l?0:Math.abs(l);return{g:e,anchor:n,leadPath:r,reverse:s,watts:l,color:d,icon:c,beadDur:u<5?null:flowDuration(u,5e3)}}):[],Pe=null!==I?Math.abs(pvNormalizeToWatts(I,W)):0,Fe=null!==U?Math.abs(pvNormalizeToWatts(U,G)):0,proportionalBeadDur=(e,t)=>{const i=Math.max(e,1);return Math.min(8,Math.max(1.2,1.2*t/i))},Ie=Pe<5?null:proportionalBeadDur(Pe,5e3),Ue=Fe<5?null:proportionalBeadDur(Fe,1e3),We=(I??0)>=(U??0),Ne=chipSlotColor(this.host,n,"gridImport"),Be=chipSlotColor(this.host,n,"gridExport"),Ve=We?Ne:Be;this._gridLeaderColor=Ve;const qe=We?Ie:Ue,Ge=this.host._sunScene,Ke=e&&null!==Ge&&Ge.arc.length>=2,Ye=ENERGY_COLOR_sun(this.host),Ze=function darkenHex(e,t){const i=1-Math.max(0,Math.min(1,t)),n=Math.round(parseInt(e.slice(1,3),16)*i),r=Math.round(parseInt(e.slice(3,5),16)*i),s=Math.round(parseInt(e.slice(5,7),16)*i),h=e=>e.toString(16).padStart(2,"0");return`#${h(n)}${h(r)}${h(s)}`}(Ye,.2),Je=Ke?function buildArcSegments(e,t){const i=[];for(let n=0;n<e.length-1;n++){const r=e[n],s=e[n+1];i.push({x1:r.x,y1:r.y,x2:s.x,y2:s.y,color:arcColor(.5*(r.altitude+s.altitude),t),nearness:.5*(r.nearness+s.nearness),belowHorizon:r.belowHorizon||s.belowHorizon})}return i}(Ge.arc,Ye):[],Xe=this.host._arcBackBuf,Qe=this.host._arcFrontBuf,et=this.host._arcFrontNearBuf;Xe.length=0,Qe.length=0,et.length=0;for(const B of Je)B.belowHorizon?Xe.push(B):B.nearness>=.5?et.push(B):Qe.push(B);const tt=Ke&&Ge.sun.altitude>0,it=Ge?.sun.irradiance??0,at=formatIrradiance(this.host.hass,it,H,j),ot=Math.sqrt(Math.max(0,Math.min(1,it/1e3))),nt=Ke&&r&&Ge.sun.altitude>0&&this.host._weatherAvailable,rt=flowDuration(it,1e3,.8);let st=Ge?.home.x??0,lt=Ge?.home.y??0;if(i&&Ge&&_){const e=i.pvLabel.x,t=i.pvLabel.y,n=28,r=11,s=Ge.sun.x-e,l=Ge.sun.y-t,d=Math.max(0,n-r);if(Math.abs(s)<=d)st=Ge.sun.x,lt=t+(l>=0?1:-1)*r;else{const i=e+(s>=0?1:-1)*d,n=t,l=Ge.sun.x-i,c=Ge.sun.y-n,u=Math.sqrt(l*l+c*c)||1;st=i+r*l/u,lt=n+r*c/u}}return B`
                ...
                ${Ke&&Xe.length>0?B`
                    <svg
                        ...
                        style="--solar-daylight:${Ge.daylight}"
                    >
                        ${Xe.map(e=>q`
                            <line
                                ...
                                x1="${e.x1}" y1="${e.y1}"
                                x2="${e.x2}" y2="${e.y2}"
                                stroke-width="${.5*(Bt+3.5*e.nearness)}"
                            ></line>
                        `)}
                        ${Xe.map(e=>q`
                            <line
                ...
                ${ee?B`
                    ...
                    <div
                        ...
                        style="left:${be}px; top:${ye}px; --battery-leader-color:${ge}"
                        role=${t?"button":K}
                        tabindex=${t?"0":K}
                        data-target="battery"
                        @click=${t?this.host.onChartTargetClick:void 0}
                ...
                ${!e||!l||null===i||null===I&&null===U||O?K:B`
                    <svg class="grid-leader-svg">
                        <path class="grid-leader-line" style="stroke:${Ve}" d=${je} />
                        ...
                        ${null!==qe?We?q`
                            <circle class="grid-leader-bead" r="3" style="fill:${Ve}">
                                <animateMotion dur="${qe.toFixed(2)}s" repeatCount="indefinite"
                                               path="${je}" />
                            </circle>
                        `:q`
                            <circle class="grid-leader-bead" r="3" style="fill:${Ve}">
                    ...
                    >
                        ...
                        <span>${formatGridValue(this.host.hass,We?I??0:U??0,We?W:G,H,$)}</span>
                    </div>
                `}
                ...
                ${e&&null!==i?Le.map(e=>B`
                    ...
                    >
                        ...
                        <span>${null===e.watts?"":formatPvValue(this.host.hass,e.watts,"W",H,$)}</span>
                    </div>
                `):K}
                    ...
                    >
                        ${Qe.map(e=>q`
                            <line
                                ...
                                x1="${e.x1}" y1="${e.y1}"
                                x2="${e.x2}" y2="${e.y2}"
                                stroke-width="${Bt+3.5*e.nearness}"
                            ></line>
                        `)}
                        ${Qe.map(e=>q`
                            <line
                    ...
                    <svg class="solar-svg solar-ray-svg"
                        ...
                        >
                            <animateMotion
                                dur="${rt}s"
                                repeatCount="indefinite"
                                path="M ${Ge.sun.x},${Ge.sun.y} L ${st},${lt}"
                            ></animateMotion>
                        </circle>
                    </svg>
                `:K}
                ...
                ${Ke?B`
                    <svg
                        class="solar-svg solar-svg-sun ${Ge.sun.nearness>=.5?"solar-svg-sun-near":"solar-svg-sun-far"}"
                        style="--solar-daylight:${Ge.daylight}"
                    >
                        ${(()=>{const e=this.host._engine?.getSunArcScale()??1,t=Math.min((10+10*Ge.sun.nearness)*e,22),i=t*ot,n=3*t,r=.55*ot;return q`
                                <defs>
                                    <radialGradient id="solar-halo-grad-${this.host._instanceId}">
                                        <stop offset="0%"   stop-color="${Ye}" stop-opacity="${r}"></stop>
                                        <stop offset="100%" stop-color="${Ye}" stop-opacity="0"></stop>
                                    </radialGradient>
                                </defs>
                                <circle
                                    class="solar-sun-halo"
                                    cx="${Ge.sun.x}" cy="${Ge.sun.y}"
                                    r="${n}"
                ...
                ${nt?B`
                    <div
                        ...
                        style="left:${Ge.sun.x}px; top:${Ge.sun.y-22}px; --solar-color:${c}"
                        role=${t?"button":K}
                        tabindex=${t?"0":K}
                ...
                ${Ke&&Ge&&function showSunTimes(e){return!1!==e?.["show-sun-times"]}(n)?B`
                    ${this._renderSunCrossing(Ge.sunrise,Ge.home,"mdi:weather-sunset-up",Ye)}
                    ${this._renderSunCrossing(Ge.sunset,Ge.home,"mdi:weather-sunset-down",Ye)}
                `:K}
                ...
                ${e&&null!==i?u?B`<div class="home-ring" style="left:${i.home.x}px; top:${i.home.y}px; --home-ring-color:${chipSlotColor(this.host,n,"home")}"></div>`:B`
                    <div
                        class="home-pill ${le?"has-usage":""} ${this.host._homeHover?"is-hovered":""} ${t&&"consumption"===this.host._chartTarget?"is-chart-active":""}"
    ...
    `}(this)}
                ...
                ${s&&e&&function showDetailPanel(e){return!1!==e?.["show-detail-panel"]}(this.config)?function renderDetailPanel(e){const t=buildMetrics(e,e._chartTarget??"production");return t.length?B`
    ...
    `:K}(this):K}
        ...
        `}_maybeRebuildUnifiedStore(){(function isStoreFresh(e,t){return!!t&&t.dataVersion===computeDataVersion(e)})(this,this._unifiedStore)||(this._unifiedStore=buildUnifiedStore(this))}_isCameraLocked(){return!!this._engine&&this._engine.isCameraLocked()}_registerCacheId(){const e=cacheId(this.config);if(!e)return;const t=qt.get(e)??[];t.includes(this)||(t.push(this),qt.set(e,t))}_unregisterCacheId(){const e=cacheId(this.config),t=e?qt.get(e):void 0;if(!t)return;const i=t.indexOf(this);i>=0&&t.splice(i,1),0===t.length&&qt.delete(e)}effectiveCacheId(){const e=cacheId(this.config);if(!e)return"";const t=qt.get(e),i=t?t.indexOf(this):-1;return i>0?`${e}#${i+1}`:e}_uiStateStorageKey(){const e=this.effectiveCacheId();if(e)return`helios:ui-state:${e}`;const t=getHomeCoords(this.config,this.hass);return t?`helios:ui-state:${Math.round(1e3*t.lat)/1e3}:${Math.round(1e3*t.lon)/1e3}`:null}_restoreUiState(){if(this._uiStateRestored)return;const e=this._uiStateStorageKey();if(e){this._uiStateRestored=!0;try{const t=window.localStorage.getItem(e);if(!t)return;const i=JSON.parse(t);if(i&&"object"==typeof i){const e=["production","consumption","grid","battery","battery-soc","irradiance",..._t];"string"==typeof i.chartTarget&&e.includes(i.chartTarget)&&(this._chartTarget=i.chartTarget),"string"==typeof i.timelineMode&&i.timelineMode in Be&&(this._timelineMode=i.timelineMode,this._periodPastDays=modePastDays(this._timelineMode),this._periodFutureDays=modeFutureDays(this._timelineMode))}}catch(L){}}}persistUiState(){const e=this._uiStateStorageKey();if(e)try{window.localStorage.setItem(e,JSON.stringify({chartTarget:this._chartTarget,timelineMode:this._timelineMode}))}catch(L){}}},Nt.styles=[Ye,Ze],Nt);__decorate([n$1({attribute:!1}),__decorateMetadata("design:type",Object)],Gt.prototype,"hass",void 0),__decorate([n$1({attribute:!1}),__decorateMetadata("design:type",Object)],Gt.prototype,"config",void 0),__decorate([n$1({attribute:!1}),__decorateMetadata("design:type",Object)],Gt.prototype,"preview",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_engine",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_now",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_cloudCover",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_labelLayout",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_pvCurrent",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_pvUnit",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_pvChangeSeries",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_pvChangeSeriesPerEntity",void 0),__decorate([r$1(),__decorateMetadata("design:type",Array)],Gt.prototype,"_haSolarForecast",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_batterySoc",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_batteryPower",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_batteryPowerUnit",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_gridImportValue",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_gridImportUnit",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_gridExportValue",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_gridExportUnit",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_gridImportChangeSeries",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_gridExportChangeSeries",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_batterySocHistory",void 0),__decorate([r$1(),__decorateMetadata("design:type",Array)],Gt.prototype,"_batterySocPerBankHistory",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_periodHourly",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_batteryChargeChangeSeries",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_batteryDischargeChangeSeries",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_deviceChangeSeries",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_sunScene",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_energyDefaults",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_haSolarTodayKwh",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_homeHover",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_chartHoverPct",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_chartTarget",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_infoPanelOpen",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_uiHidden",void 0),__decorate([e$2("ha-card"),__decorateMetadata("design:type","undefined"==typeof HTMLElement?Object:HTMLElement)],Gt.prototype,"_haCard",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_chartSeries",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_timeRange",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_selectedTime",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_isLiveMode",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_timelineMode",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Gt.prototype,"_unifiedStore",void 0),Gt=__decorate([t$2("helios-card")],Gt);export{Gt as HeliosCard};