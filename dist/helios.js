                    ...
                    <svg class="solar-svg solar-ray-svg"
                        ...
                        >
                            <animateMotion
                                dur="${De}s"
                                repeatCount="indefinite"
                                path="M ${_e.sun.x},${_e.sun.y} L ${Re},${Pe}"
                            ></animateMotion>
                        </circle>
                    </svg>
                `:K}
