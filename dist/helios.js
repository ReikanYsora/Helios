...
<!--  Camera lock chip (top-left). Tapping flips the
                    ...
                    >
                        ${ke.map(e=>B`
                            <line
                                ...
                                x1="${e.x1}" y1="${e.y1}"
                                x2="${e.x2}" y2="${e.y2}"
                                stroke-width="${(lt.OUTLINE_FAR+(lt.OUTLINE_NEAR-lt.OUTLINE_FAR)*e.nearness)*lt.NIGHT_STROKE_FACTOR}"
                            ></line>
                        `)}
                        ${ke.map(e=>B`
                            <line
                                ...
                                x2="${e.x2}" y2="${e.y2}"
                                stroke="${e.color}"
                                stroke-width="${(lt.SEGMENT_FAR+(lt.SEGMENT_NEAR-lt.SEGMENT_FAR)*e.nearness)*lt.NIGHT_STROKE_FACTOR}"
                            ></line>
                        `)}
                    </svg>
                `:K}
                    ...
                    >
                        ${Me.map(e=>B`
                            <line
                                ...
                                x1="${e.x1}" y1="${e.y1}"
                                x2="${e.x2}" y2="${e.y2}"
                                stroke-width="${lt.OUTLINE_FAR+(lt.OUTLINE_NEAR-lt.OUTLINE_FAR)*e.nearness}"
                            ></line>
                        `)}
                        ${Me.map(e=>B`
                            <line
                                ...
                                x2="${e.x2}" y2="${e.y2}"
                                stroke="${e.color}"
                                stroke-width="${lt.SEGMENT_FAR+(lt.SEGMENT_NEAR-lt.SEGMENT_FAR)*e.nearness}"
                            ></line>
                        `)}
                    </svg>
                `:K}
                ...
                ${we?U`
                    <svg
                        ...
                        style="--solar-daylight:${_e.daylight}"
                    >
                        ${(()=>{const e=this._engine?.getSunArcScale()??1,t=Math.min((lt.SUN_R_FAR+(lt.SUN_R_NEAR-lt.SUN_R_FAR)*_e.sun.nearness)*e,22),i=t*He,r=3*t;return B`
                                <defs>
                                ...
                                <circle
                                    ...
                                    r="${t}"
                                    fill="${xe}"
                                    fill-opacity="${lt.SUN_FILL_OPACITY_BG}"
                                ></circle>
                                <circle
                ...
                ${Ee&&this._cloudCover>=0?(()=>{const e=_e.sun.x,t=_e.sun.y-22,i=t-lt.CHIP_HALF_H_PX,r=this._engine?.getViewportWidth()??0,o=lt.CHIP_HALF_W_PX,n=o+16+76,s=r<=0||e+n<=r-8?1:e-n>=8?-1:e<r/2?1:-1,l=s>0?e+o+16:e-o-16,c=s>0?"translate(0, -100%)":"translate(-100%, -100%)";return U`
                        <div
