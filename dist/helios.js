        ...
        >
            <div class="tb-hover-tooltip">
                ...
                ${"cloud"===y?U`
                    ${isFinite(m)?U`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${L}" icon="mdi:format-vertical-align-top"></ha-icon>
                    ...
                    ${isFinite(u)?U`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${P}" icon="mdi:format-vertical-align-bottom"></ha-icon>
                ...
                <details class="advanced-section about-section" data-section="about" ?open=${"about"===this._openSection} @toggle=${this._onSectionToggleEvt}>
                    ...
                    <div class="about-row">
                        ...
                        <a class="about-row-link about-version-link"
                           href="https://github.com/ReikanYsora/Helios/releases/tag/v${"2026.7.1-a11"}"
...
<!--  Camera lock chip (top-left). Tapping flips the
                ...
                ${De?U`
                    <svg
                        ...
                        style="--solar-daylight:${Ae.daylight}"
                    >
                        ${(()=>{const e=this._engine?.getSunArcScale()??1,t=Math.min((St.SUN_R_FAR+(St.SUN_R_NEAR-St.SUN_R_FAR)*Ae.sun.nearness)*e,22),i=t*Ue,r=3*t;return q`
                                <defs>
                                    <radialGradient id="solar-halo-grad">
                                        <stop offset="0%"   stop-color="${Re}" stop-opacity="${.55*Ue}"></stop>
                ...
                ${Ve&&this._cloudCover>=0?(()=>{const e=Ae.sun.x,t=Ae.sun.y-22,i=t-St.CHIP_HALF_H_PX,r=this._engine?.getViewportWidth()??0,s=St.CHIP_HALF_W_PX,n=s+16+76,l=r<=0||e+n<=r-8?1:e-n>=8?-1:e<r/2?1:-1,c=l>0?e+s+16:e-s-16,d=l>0?"translate(0, -100%)":"translate(-100%, -100%)";return U`
                        <div
