        ...
        >
            <div class="tb-hover-tooltip">
                <div class="tb-hover-tooltip-time">
                    ...
                    <span
                        class="tb-hover-tooltip-live-chip ${ee?"is-visible":""}"
                        title=${ie}
                        aria-label=${ie}
                        aria-hidden=${ee?"false":"true"}
                    >
                ...
                ${"production"===y?U`
                    ...
                    ${A?U`
                        <div class="tb-hover-tooltip-row">
                            ...
                            <span class="tb-hover-tooltip-value">${formatLocalisedNumber(e.hass,f.value,te)} ${f.unit}</span>
                        </div>
                    `:G}
                    ${E.map(t=>U`
                ...
                ${"custom"===y&&isFinite(m)?U`
                    <div class="tb-hover-tooltip-row">
                        ...
                        <span class="tb-hover-tooltip-value">${formatLocalisedNumber(e.hass,Math.abs(m)/1e3,1)} kW</span>
                    </div>
                `:G}
                ${"cloud"===y?U`
                    ${isFinite(g)?U`
                ...
                <details class="advanced-section about-section" data-section="about" ?open=${"about"===this._openSection} @toggle=${this._onSectionToggleEvt}>
                    ...
                    <div class="about-row">
                        ...
                        <a class="about-row-link about-version-link"
                           href="https://github.com/ReikanYsora/Helios/releases/tag/v${"2026.7.1-a12"}"
