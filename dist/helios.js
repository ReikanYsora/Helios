                ...
                ${"production"===f?B`
                    ${ge&&be?B`
                        <div class="tb-hover-tooltip-row">
                            ...
                            <span class="tb-hover-tooltip-value">${be}</span>
                        </div>
                    `:K}
                    ${T?B`
                        <div class="tb-hover-tooltip-row">
