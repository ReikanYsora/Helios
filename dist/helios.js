        ...
        >
            <div class="tb-hover-tooltip">
                ...
                ${"production"===f?B`
                    ...
                    ${T?B`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${m.isPredicted?ee:chipSlotColor(q,e.config,"production")}" icon=${m.isPredicted?"mdi:crystal-ball":chipSlotIcon(e.config,"production","mdi:solar-power")}></ha-icon>
                ...
                ${"consumption"===f&&j?B`
                    <div class="tb-hover-tooltip-row">
                        <ha-icon class="tb-hover-tooltip-icon" style="color:${chipSlotColor(q,e.config,"home")}" icon=${chipSlotIcon(e.config,"home","mdi:home-lightning-bolt")}></ha-icon>
                ...
                ${"grid"===f?B`
                    ${isFinite(b)&&b>=1?B`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${chipSlotColor(q,e.config,"gridImport")}" icon=${chipSlotIcon(e.config,"gridImport","mdi:transmission-tower-export")}></ha-icon>
                    ...
                    ${isFinite(y)&&y>=1?B`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${chipSlotColor(q,e.config,"gridExport")}" icon=${chipSlotIcon(e.config,"gridExport","mdi:transmission-tower-import")}></ha-icon>
                ...
                ${"battery"===f?B`
                    ${isFinite(w)&&w>=1?B`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${chipSlotColor(q,e.config,"batteryCharge")}" icon=${chipSlotIcon(e.config,"batteryCharge","mdi:battery-arrow-up")}></ha-icon>
                    ...
                    ${isFinite(w)&&w<=-1?B`
                        <div class="tb-hover-tooltip-row">
                            <ha-icon class="tb-hover-tooltip-icon" style="color:${chipSlotColor(q,e.config,"batteryDischarge")}" icon=${chipSlotIcon(e.config,"batteryDischarge","mdi:battery-arrow-down")}></ha-icon>
                            <span class="tb-hover-tooltip-name">${G}</span>
                            <span class="tb-hover-tooltip-value">${kw(-w)}</span>
                        </div>
                    `:K}
                ...
                ${"battery-soc"===f&&isFinite(M)?B`
                    <div class="tb-hover-tooltip-row">
                        <ha-icon class="tb-hover-tooltip-icon" style="color:${chipSlotColor(q,e.config,"batteryDischarge")}" icon="mdi:battery"></ha-icon>
                        <span class="tb-hover-tooltip-name">${P}</span>
                ...
                ${"irradiance"===f&&isFinite(c)?B`
                    <div class="tb-hover-tooltip-row">
                        <ha-icon class="tb-hover-tooltip-icon" style="color:${chipSlotColor(q,e.config,"irradiance")}" icon=${chipSlotIcon(e.config,"irradiance","mdi:white-balance-sunny")}></ha-icon>
                        <span class="tb-hover-tooltip-name">${P}</span>
                        <span class="tb-hover-tooltip-value">${formatIrradiance(e.hass,c,C,D)}</span>
                    </div>
                `:K}
...
`;function __decorateMetadata(e,t){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(e,t)}function __decorate(e,t,i,n){var r,s=arguments.length,l=s<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(e,t,i,n);else for(var d=e.length-1;d>=0;d--)(r=e[d])&&(l=(s<3?r(l):s>3?r(t,i,l):r(t,i))||l);return s>3&&l&&Object.defineProperty(t,i,l),l}var Et={land:"Background",water:"Water",wood:"Woodland",grass:"Greenery",sand:"Sand",wetland:"Wetland",ice:"Ice & snow",landuse:"Built-up land",roadMajor:"Major roads",roadMinor:"Minor roads",roadCasing:"Road outline",path:"Paths & tracks",rail:"Railways",building:"Buildings",boundary:"Boundaries"},Tt=(Dt=class HeliosCardEditor extends le{constructor(...e){super(...e),this._cfg={},this._pickerReady=!1,this._colorNonce=0,this._openSection=null,this._sliderDebounce=/* @__PURE__ */new Map,this._energyDefaults=Xe,this._energyDefaultsLoaded=!1,this._gridGuard={status:"unknown",cleanEvals:0,fetchKey:"",fetching:!1,entityKey:""},this._onSectionToggleEvt=e=>{const t=e.currentTarget.dataset.section;t&&this._onSectionToggle(t,e)},this._onNumFieldChange=e=>{const t=e.currentTarget.dataset.key;t&&this._numField(t,e)},this._onNumSliderInput=e=>{const t=e.currentTarget.dataset.key;t&&this._numSlider(t,e)},this._onEntityValueChanged=e=>{const t=e.currentTarget.dataset.key;if(!t)return;const i=e.detail.value,n=null==i||""===i,r=n?void 0:i;n&&this._colorNonce++,(this._cfg[t]??void 0)!==(r??void 0)&&this._update(t,r)},this._onBoolToggleClick=e=>{const t=e.currentTarget,i=t.dataset.key;i&&this._update(i,"true"===t.dataset.value)},this._onDeviceToggleClick=e=>{const t=e.currentTarget.dataset.stat;if(!t)return;const i=this._cfg["hidden-devices"],n=Array.isArray(i)?i.filter(e=>"string"==typeof e):[],r=n.includes(t)?n.filter(e=>e!==t):[...n,t];this._update("hidden-devices",r.length?r:void 0)},this._onDeviceGroupClick=e=>{const t=e.currentTarget.dataset.stat;if(!t)return;const i=monitoringGroups(this._cfg),n=(i.get(t)??0)+1,r=n>4?0:n,s={};for(const[l,d]of i)l!==t&&(s[l]=d);r>=1&&(s[t]=r),this._update("monitoring-groups",Object.keys(s).length?s:void 0)},this._solarIrradianceEntityFilter=e=>{if(!e||!e.attributes)return!1;if("irradiance"===e.attributes.device_class)return!0;const t=String(e.attributes.unit_of_measurement??"").trim();return"W/m²"===t||"W/m2"===t},this._onMapModeClick=e=>{const t=e.currentTarget.dataset.value;if(!t||t===mapThemeMode(this._cfg))return;const i={...this._cfg};if("auto"===t?delete i["map-theme-mode"]:i["map-theme-mode"]=t,"custom"===t){const e=defaultGroundPalette(isDarkFromCss(this));for(const t of dt){const n=mapColorKey(t);i[n]||(i[n]=e[t])}}this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}})),this._cfg=i},this._onGroupNameChanged=e=>{const t=e.currentTarget;t.dataset.group&&this._updateGroupMap("monitoring-group-names",t.dataset.group,t.value.trim())},this._onGroupColorChanged=e=>{e.stopPropagation();const t=e.currentTarget.dataset.group;if(!t)return;const i="string"==typeof e.detail.value?e.detail.value:"";""===i&&this._colorNonce++,this._updateGroupMap("monitoring-group-colors",t,i)},this._onGroupIconChanged=e=>{e.stopPropagation();const t=e.currentTarget.dataset.group;t&&this._updateGroupMap("monitoring-group-icons",t,"string"==typeof e.detail.value?e.detail.value:"")},this._onGroupVisibleClick=e=>{const t=e.currentTarget,i=t.dataset.group;if(!i)return;const n=this._cfg["monitoring-group-hidden"],r=n&&"object"==typeof n&&!Array.isArray(n)?{...n}:{};"true"===t.dataset.value?delete r[i]:r[i]=!0,this._update("monitoring-group-hidden",Object.keys(r).length?r:void 0)},this._resetFeedback=null,this._optionsResetArmed=!1,this._optionsResetFeedback=null}disconnectedCallback(){super.disconnectedCallback(),unsubscribeEnergyPrefs(this);for(const e of this._sliderDebounce.values())window.clearTimeout(e);this._sliderDebounce.clear();for(const e of[this._resetFeedbackTimer,this._optionsResetConfirmTimer,this._optionsResetFeedbackTimer])void 0!==e&&window.clearTimeout(e);this._resetFeedbackTimer=void 0,this._optionsResetConfirmTimer=void 0,this._optionsResetFeedbackTimer=void 0}setConfig(e){if(this._cfg={...e},At.LEGACY_KEYS.some(e=>e in this._cfg)&&setTimeout(()=>{if(!this.isConnected)return;const e={...this._cfg};let t=!1;for(const i of At.LEGACY_KEYS)i in e&&(delete e[i],t=!0);t&&(this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e}})),this._cfg=e)},0),!this._cfg["cache-id"]){const e=`c${Date.now().toString(36)}${Math.floor(1e9*Math.random()).toString(36)}`;setTimeout(()=>{this.isConnected&&(this._cfg["cache-id"]||this._update("cache-id",e))},0)}}connectedCallback(){super.connectedCallback(),this._ensureEntityPicker(),subscribeEnergyPrefs(this)}async _ensureEntityPicker(){if(!this._pickerReady)if("undefined"!=typeof customElements&&customElements.get("ha-entity-picker"))this._pickerReady=!0;else try{const e=window;if("function"==typeof e.loadCardHelpers){const t=await e.loadCardHelpers();if(t?.createCardElement){const e=(await t.createCardElement({type:"entities",entities:[]}))?.constructor;"function"==typeof e?.getConfigElement&&await e.getConfigElement()}}"undefined"!=typeof customElements&&await Promise.race([customElements.whenDefined("ha-entity-picker"),new Promise(e=>{setTimeout(e,At.PICKER_LOAD_TIMEOUT_MS)})])}catch(e){}finally{this._pickerReady=!0}}_t(){return pickTranslations(this.hass?.language)}updated(){this.hass&&refreshGridGuard(this),this._pruneStaleDeviceIds()}_pruneStaleDeviceIds(){if(!this._energyDefaultsLoaded)return;const e=this._energyDefaults.devices;if(0===e.length)return;const t=new Set(e.map(e=>e.statConsumption)),i=["hidden-devices"],n={...this._cfg};let r=!1;for(const l of i){const e=this._cfg[l];if(!Array.isArray(e))continue;const i=e.filter(e=>"string"==typeof e&&t.has(e));i.length!==e.length&&(r=!0,i.length?n[l]=i:delete n[l])}const s=this._cfg["monitoring-groups"];if(s&&"object"==typeof s&&!Array.isArray(s)){const e={};let i=!1;for(const[n,r]of Object.entries(s))t.has(n)&&"number"==typeof r?e[n]=r:i=!0;i&&(r=!0,Object.keys(e).length?n["monitoring-groups"]=e:delete n["monitoring-groups"])}r&&(this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n}})),this._cfg=n)}_liveStatusLine(e,t,i){return B`
        ...
        `}_renderMapSection(e){const t=mapThemeMode(this._cfg),i=e.mapConfig,opt=(e,i)=>B`
            ...
            ${"custom"===t?dt.map(t=>this._renderMapLayerBlock(e,t)):K}`}_mapLayerLabel(e,t){return e.mapConfig?.[t]??Et[t]}_renderMapLayerBlock(e,t){const i=mapLayerVisible(this._cfg,t),n=mapLayerColor(this._cfg,t)||defaultGroundPalette(isDarkFromCss(this))[t];return B`
        ...
        `}_renderChipBox(e,t,i){const n=this._cfg,r=chipVisible(this._cfg,t),s=this._t();return B`
                <div class="group-block">
                    ...
                    ${this._pickerReady?i.map(e=>{const t=zt[e];return B`
                        <div class="group-line chip-body">
                            <ha-selector
                                class="chip-picker"
                                .hass=${this.hass}
        ...
        `}_onResetCacheClick(){try{window.dispatchEvent(new CustomEvent("helios-data-cache-reset"))}catch(L){}const e=pickTranslations(this.hass?.language);this._resetFeedback=e.editor.resetCacheDone,void 0!==this._resetFeedbackTimer&&window.clearTimeout(this._resetFeedbackTimer),this._resetFeedbackTimer=window.setTimeout(()=>{this._resetFeedback=null},At.RESET_FEEDBACK_MS)}_onResetOptionsClick(){if(!this._optionsResetArmed)return this._optionsResetArmed=!0,void 0!==this._optionsResetConfirmTimer&&window.clearTimeout(this._optionsResetConfirmTimer),void(this._optionsResetConfirmTimer=window.setTimeout(()=>{this._optionsResetArmed=!1},4e3));this._optionsResetArmed=!1,void 0!==this._optionsResetConfirmTimer&&window.clearTimeout(this._optionsResetConfirmTimer);const e=this._cfg,t={};for(const n of At.LOVELACE_KEYS)void 0!==e[n]&&(t[n]=e[n]);this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t}})),this._cfg=t;const i=pickTranslations(this.hass?.language);this._optionsResetFeedback=i.editor.resetOptionsDone??"Options reset ✓",void 0!==this._optionsResetFeedbackTimer&&window.clearTimeout(this._optionsResetFeedbackTimer),this._optionsResetFeedbackTimer=window.setTimeout(()=>{this._optionsResetFeedback=null},At.RESET_FEEDBACK_MS)}},At=Dt,Dt.SLIDER_COMMIT_DELAY_MS=250,Dt.PICKER_LOAD_TIMEOUT_MS=8e3,Dt.RESET_FEEDBACK_MS=2e3,Dt.LEGACY_KEYS=["custom-power-entity","custom-energy-entity","custom-entity","custom-entity-icon","custom-entity-color"],Dt.LOVELACE_KEYS=["type","view_layout","grid_options","layout_options"],Dt.styles=Rt,Dt);__decorate([n$1({attribute:!1}),__decorateMetadata("design:type",Object)],Tt.prototype,"hass",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Tt.prototype,"_cfg",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Tt.prototype,"_pickerReady",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Tt.prototype,"_colorNonce",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Tt.prototype,"_openSection",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Tt.prototype,"_energyDefaults",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Tt.prototype,"_energyDefaultsLoaded",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Tt.prototype,"_resetFeedback",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Tt.prototype,"_optionsResetArmed",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Tt.prototype,"_optionsResetFeedback",void 0),Tt=At=__decorate([t$2("helios-card-editor")],Tt);var Ot=pickTranslations("undefined"!=typeof navigator?navigator.language:"en");window.customCards=window.customCards||[];{const e={type:"helios-card",name:Ot.cardName,description:Ot.cardDescription,preview:!0},t=window.customCards.findIndex(e=>"helios-card"===e.type);t>=0?window.customCards[t]=e:window.customCards.push(e)}var Lt=/* @__PURE__ */new Set;{const e="__heliosBannerPrinted",t=window;t[e]||(t[e]=!0,console.info("%c☀ HELIOS%c v2026.8.0-b3","background:#f59e0b;color:#1f2937;padding:2px 8px;border-radius:4px 0 0 4px;font-weight:bold;","background:#1f2937;color:#f59e0b;padding:2px 8px;border-radius:0 4px 4px 0;font-weight:bold;"))}{const e=window;e.setHeliosLocation||(e.setHeliosLocation=(t,i)=>{if(!("number"!=typeof t||"number"!=typeof i||!isFinite(t)||!isFinite(i)||t<-90||t>90||i<-180||i>180)){e.__heliosLocationOverride={lat:t,lon:i};for(const e of Lt)e.invalidateLocation()}}),e.clearHeliosLocation||(e.clearHeliosLocation=()=>{if(e.__heliosLocationOverride){e.__heliosLocationOverride=void 0;for(const e of Lt)e.invalidateLocation()}})}window.addEventListener("helios-data-cache-reset",()=>{for(const e of Lt)e.resetDataCache()});var Pt,Ft=1.5,It=class{constructor(e){this.host=e,this._gridLeaderColor="var(--energy-grid-consumption-color, #488fc2)",this._batteryLeaderColor="var(--energy-battery-out-color, #4db6ac)"}_nudgeToHomePill(e,t,i,n){return function nudgeToHomePill(e,t,i,n,r,s){const l=e-i,d=t-n,c=Math.max(0,r-s);if(Math.abs(l)<=c)return{x:e,y:n+(d>=0?1:-1)*s};const u=i+(l>=0?1:-1)*c,p=e-u,g=t-n,m=Math.sqrt(p*p+g*g)||1;return{x:u+s*p/m,y:n+s*g/m}}(e,t,i,n,38,14)}_buildLPathToHome(e,t,i,n){if(!e)return"";const r=e.home.x,s=e.home.y,l=r>t?1:-1,d=s>i?1:-1,c=t+l*n,u=i,p=r-13*l,g=s-14*d,m=Math.min(12,Math.abs(p-c)/2,Math.abs(g-u)/2),f=p-l*m,v=u+d*m;return`M ${c.toFixed(1)},${u.toFixed(1)} L ${f.toFixed(1)},${u.toFixed(1)} Q ${p.toFixed(1)},${u.toFixed(1)} ${p.toFixed(1)},${v.toFixed(1)} L ${p.toFixed(1)},${g.toFixed(1)}`}_buildLPath(e,t,i,n,r){const s=i>e?1:-1,l=n>t?1:-1,d=Math.min(12,Math.abs(i-e)/2,Math.abs(n-t)/2);if(r){const r=n-l*d,c=e+s*d;return`M ${e.toFixed(1)},${t.toFixed(1)} L ${e.toFixed(1)},${r.toFixed(1)} Q ${e.toFixed(1)},${n.toFixed(1)} ${c.toFixed(1)},${n.toFixed(1)} L ${i.toFixed(1)},${n.toFixed(1)}`}const c=i-s*d,u=t+l*d;return`M ${e.toFixed(1)},${t.toFixed(1)} L ${c.toFixed(1)},${t.toFixed(1)} Q ${i.toFixed(1)},${t.toFixed(1)} ${i.toFixed(1)},${u.toFixed(1)} L ${i.toFixed(1)},${n.toFixed(1)}`}_buildVerticalLeadFromHome(e,t,i){const n=e.home.y+14;return`M ${t.toFixed(1)},${n.toFixed(1)} L ${t.toFixed(1)},${i.toFixed(1)}`}_renderSunCrossing(e,t,i,n){if(!e)return K;const r=e.x-t.x,s=e.y-t.y,l=Math.hypot(r,s)||1,d=e.x+r/l*22,c=e.y+s/l*22,u=function formatHaTime(e,t){const i=e?.locale,n={hour:"numeric",minute:"2-digit",hour12:haUseAmPm(i)};try{return new Intl.DateTimeFormat(i?.language,n).format(t)}catch(L){return new Intl.DateTimeFormat(void 0,n).format(t)}}(this.host.hass,e.time);return B`
            <div
                    ...
                    >
                        ${Xe.map(e=>G`
                            <line
                                ...
                                x1="${e.x1}" y1="${e.y1}"
                                x2="${e.x2}" y2="${e.y2}"
                                stroke-width="${.5*(Ft+3.5*e.nearness)}"
                            ></line>
                        `)}
                        ${Xe.map(e=>G`
                            <line
                    ...
                    >
                        ${Qe.map(e=>G`
                            <line
                                ...
                                x1="${e.x1}" y1="${e.y1}"
                                x2="${e.x2}" y2="${e.y2}"
                                stroke-width="${Ft+3.5*e.nearness}"
                            ></line>
                        `)}
                        ${Qe.map(e=>G`
                            <line
    ...
    `:K}(this):K}
        ...
        `}_maybeRebuildUnifiedStore(){(function isStoreFresh(e,t){return!!t&&t.dataVersion===computeDataVersion(e)})(this,this._unifiedStore)||(this._unifiedStore=buildUnifiedStore(this))}_isCameraLocked(){return!!this._engine&&this._engine.isCameraLocked()}_registerCacheId(){const e=cacheId(this.config);if(!e)return;const t=Ut.get(e)??[];t.includes(this)||(t.push(this),Ut.set(e,t))}_unregisterCacheId(){const e=cacheId(this.config),t=e?Ut.get(e):void 0;if(!t)return;const i=t.indexOf(this);i>=0&&t.splice(i,1),0===t.length&&Ut.delete(e)}effectiveCacheId(){const e=cacheId(this.config);if(!e)return"";const t=Ut.get(e),i=t?t.indexOf(this):-1;return i>0?`${e}#${i+1}`:e}_uiStateStorageKey(){const e=this.effectiveCacheId();if(e)return`helios:ui-state:${e}`;const t=getHomeCoords(this.config,this.hass);return t?`helios:ui-state:${Math.round(1e3*t.lat)/1e3}:${Math.round(1e3*t.lon)/1e3}`:null}_restoreUiState(){if(this._uiStateRestored)return;const e=this._uiStateStorageKey();if(e){this._uiStateRestored=!0;try{const t=window.localStorage.getItem(e);if(!t)return;const i=JSON.parse(t);if(i&&"object"==typeof i){const e=["production","consumption","grid","battery","battery-soc","irradiance",...xt];"string"==typeof i.chartTarget&&e.includes(i.chartTarget)&&(this._chartTarget=i.chartTarget),"string"==typeof i.timelineMode&&i.timelineMode in Be&&(this._timelineMode=i.timelineMode,this._periodPastDays=modePastDays(this._timelineMode),this._periodFutureDays=modeFutureDays(this._timelineMode))}}catch(L){}}}persistUiState(){const e=this._uiStateStorageKey();if(e)try{window.localStorage.setItem(e,JSON.stringify({chartTarget:this._chartTarget,timelineMode:this._timelineMode}))}catch(L){}}},Pt.styles=[Ze,Ye],Pt);__decorate([n$1({attribute:!1}),__decorateMetadata("design:type",Object)],Wt.prototype,"hass",void 0),__decorate([n$1({attribute:!1}),__decorateMetadata("design:type",Object)],Wt.prototype,"config",void 0),__decorate([n$1({attribute:!1}),__decorateMetadata("design:type",Object)],Wt.prototype,"preview",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_engine",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_now",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_cloudCover",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_labelLayout",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_pvCurrent",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_pvUnit",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_pvChangeSeries",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_pvChangeSeriesPerEntity",void 0),__decorate([r$1(),__decorateMetadata("design:type",Array)],Wt.prototype,"_haSolarForecast",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_batterySoc",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_batteryPower",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_batteryPowerUnit",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_gridImportValue",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_gridImportUnit",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_gridExportValue",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_gridExportUnit",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_gridImportChangeSeries",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_gridExportChangeSeries",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_batterySocHistory",void 0),__decorate([r$1(),__decorateMetadata("design:type",Array)],Wt.prototype,"_batterySocPerBankHistory",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_periodHourly",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_batteryChargeChangeSeries",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_batteryDischargeChangeSeries",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_deviceChangeSeries",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_sunScene",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_energyDefaults",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_haSolarTodayKwh",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_homeHover",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_chartHoverPct",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_chartTarget",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_infoPanelOpen",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_uiHidden",void 0),__decorate([function e$2(e,t){return(i,n,r)=>{const o=t=>t.renderRoot?.querySelector(e)??null;if(t){const{get:e,set:t}="object"==typeof n?i:r??(()=>{const e=Symbol();return{get(){return this[e]},set(t){this[e]=t}}})();return e$3(i,n,{get(){let i=e.call(this);return void 0===i&&(i=o(this),(null!==i||this.hasUpdated)&&t.call(this,i)),i}})}return e$3(i,n,{get(){return o(this)}})}}("ha-card"),__decorateMetadata("design:type","undefined"==typeof HTMLElement?Object:HTMLElement)],Wt.prototype,"_haCard",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_chartSeries",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_timeRange",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_selectedTime",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_isLiveMode",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_timelineMode",void 0),__decorate([r$1(),__decorateMetadata("design:type",Object)],Wt.prototype,"_unifiedStore",void 0),Wt=__decorate([t$2("helios-card")],Wt);export{Wt as HeliosCard};