                ...
                <details class="advanced-section about-section" ?open="${"about"===this._openSection}" @toggle="${e=>this._onSectionToggle("about",e)}">
                    ...
                    <div class="about-row">
                        ...
                        <a class="about-row-link about-version-link"
                           href="https://github.com/ReikanYsora/Helios/releases/tag/v${"2026.7.1-a2"}"
...
<!--  Camera lock chip (top-left). Tapping flips the
                ...
                ${We&&this._cloudCover>=0?(()=>{const e=He.sun.x,t=He.sun.y-22,i=t-vt.CHIP_HALF_H_PX,r=this._engine?.getViewportWidth()??0,s=vt.CHIP_HALF_W_PX,n=s+16+76,l=r<=0||e+n<=r-8?1:e-n>=8?-1:e<r/2?1:-1,c=l>0?e+s+16:e-s-16,d=l>0?"translate(0, -100%)":"translate(-100%, -100%)";return B`
                        <div
            ...
            >
                ...
                ${this._clockData.map(t=>{const i=clockTargetMeta(this,t.target);return B`
                        <div class="clock-tip-row">
                            ...
                            <span>${function formatClockValue(e,t,i){return"percent"===t.unit?`${Math.round(Math.max(0,i))} %`:"irradiance"===t.unit?`${Math.round(Math.max(0,i))} W/m²`:`${formatLocalisedNumber(e.hass,i/1e3,1)} kW`}(this,t,function clockHourTotal(e,t){return e.layers.reduce((e,i)=>e+Math.max(0,i.values[t]??0),0)}(t,e))}</span>
                        </div>
                    `})}
            </div>
