                ...
                <details class="advanced-section about-section" ?open="${"about"===this._openSection}" @toggle="${e=>this._onSectionToggle("about",e)}">
                    ...
                    <div class="about-row">
                        ...
                        <a class="about-row-link about-version-link"
                           href="https://github.com/ReikanYsora/Helios/releases/tag/v${"2026.7.1-a10"}"
...
<!--  Camera lock chip (top-left). Tapping flips the
                ...
                ${De&&Ie.length>0?U`
                    <svg
                        ...
                        style="--solar-daylight:${Ae.daylight}"
                    >
                        ${Ie.map(e=>q`
                            <line
                    ...
                    <svg class="solar-svg solar-ray-svg"
                        ...
                        >
                            <animateMotion
                                dur="${Ve}s"
                                repeatCount="indefinite"
                                path="M ${Ae.sun.x},${Ae.sun.y} L ${Ke},${Ge}"
                            ></animateMotion>
                        </circle>
                    </svg>
                `:G}
                ...
                ${De?U`
                    <svg
                        class="solar-svg solar-svg-sun ${Ae.sun.nearness>=.5?"solar-svg-sun-near":"solar-svg-sun-far"}"
                        style="--solar-daylight:${Ae.daylight}"
                    >
                        ${(()=>{const e=this._engine?.getSunArcScale()??1,t=Math.min((St.SUN_R_FAR+(St.SUN_R_NEAR-St.SUN_R_FAR)*Ae.sun.nearness)*e,22),i=t*Be,r=3*t;return q`
                                <defs>
                ...
                ${Ue?U`
                    <div
                        ...
                        style="left:${Ae.sun.x}px; top:${Ae.sun.y-22}px"
                        role="button"
                        tabindex="0"
                ...
                ${Ue&&this._cloudCover>=0?(()=>{const e=Ae.sun.x,t=Ae.sun.y-22,i=t-St.CHIP_HALF_H_PX,r=this._engine?.getViewportWidth()??0,s=St.CHIP_HALF_W_PX,n=s+16+76,l=r<=0||e+n<=r-8?1:e-n>=8?-1:e<r/2?1:-1,c=l>0?e+s+16:e-s-16,d=l>0?"translate(0, -100%)":"translate(-100%, -100%)";return U`
                        <div
                ...
                ${De&&Ae?U`
                    ${this._renderSunCrossing(Ae.sunrise,Ae.home,"mdi:weather-sunset-up",Re)}
                    ${this._renderSunCrossing(Ae.sunset,Ae.home,"mdi:weather-sunset-down",Re)}
                `:G}
